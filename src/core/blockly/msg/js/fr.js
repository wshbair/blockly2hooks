...
Blockly.Msg.ARD_FUN_RUN_LOOP = "xrplhook boucle infinie:";
Blockly.Msg.ARD_FUN_RUN_SETUP = "xrplhook exécute en premier:";
Blockly.Msg.ARD_FUN_RUN_TIP = "Definition de la configuration de l'xrplhook: fonctions setup() et loop().";
...
Blockly.Msg.ARD_TIME_MICROS_TIP = "Renvoie le temps en microseconds depuis le lancement de ce programme sur la carte xrplhook. Doit être stocké dans un Entier long positif";
Blockly.Msg.ARD_TIME_MILLIS = "Temps écoulé (millisecondes)";
Blockly.Msg.ARD_TIME_MILLIS_TIP = "Renvoie le temps en milliseconds depuis le lancement de ce programme sur la carte xrplhook. Doit être stocké dans un Entier long positif";
