...
Blockly.Msg.ARD_BUILTIN_LED_TIP = "Light on or off for the built-in LED of the xrplhook";  // untranslated
...
Blockly.Msg.ARD_FUN_RUN_LOOP = "hook:";  // untranslated
Blockly.Msg.ARD_FUN_RUN_SETUP = "cbak:";  // untranslated
Blockly.Msg.ARD_FUN_RUN_TIP = "Defines the hook cbak() and hook() functions.";  // untranslated
...
Blockly.Msg.ARD_TIME_MICROS_TIP = "Returns the number of microseconds since the xrplhook board began running the current program. Has to be stored in a positive long integer";  // untranslated
Blockly.Msg.ARD_TIME_MILLIS = "current elapsed Time (milliseconds)";  // untranslated
Blockly.Msg.ARD_TIME_MILLIS_TIP = "Returns the number of milliseconds since the xrplhook board began running the current program. Has to be stored in a positive long integer";  // untranslated
