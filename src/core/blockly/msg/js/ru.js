...
Blockly.Msg.ARD_BUILTIN_LED_TIP = "Включает и выключает встроенный светодиод на xrplhook";
...
Blockly.Msg.ARD_TIME_MICROS_TIP = "Возвращает сколько микросекуд прошло с запуска xrplhook в текущей программе. Значение должно храниться в большой переменной беззнакового типа";
Blockly.Msg.ARD_TIME_MILLIS = "прошло времени (в миллисекундах)";
Blockly.Msg.ARD_TIME_MILLIS_TIP = "Возвращает количество миллисекунд прошедших с запуска xrplhook в текущей программе. Значение должно храниться в большой переменной беззнакового типа";
