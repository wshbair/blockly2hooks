...
Blockly.Msg.ARD_BUILTIN_LED_TIP = "Licht aan of uit voor de ingebouwde LED op de xrplhook";
...
Blockly.Msg.ARD_FUN_RUN_LOOP = "xrplhook herhaal voor altijd:";
Blockly.Msg.ARD_FUN_RUN_SETUP = "xrplhook doe eerst:";
Blockly.Msg.ARD_FUN_RUN_TIP = "Definieer de xrplhook setup() en loop() functies.";
...
Blockly.Msg.ARD_SERIAL_PRINT_TIP = "Drukt de gegeven data naar de seriele poort als leesbare ASCII tekst (in xrplhook IDE open de seriele poort met icoon rechtsboven).";
...
Blockly.Msg.ARD_TIME_MICROS_TIP = "Geeft aantal microseconden terug sinds start van de xrplhook. Moet je opslaan in een positief lang geheel getal!";
Blockly.Msg.ARD_TIME_MILLIS = "tijd sinds start (milliseconden)";
Blockly.Msg.ARD_TIME_MILLIS_TIP = "Geeft aantal milliseconden terug sinds start van de xrplhook. Moet je opslaan in een positief lang geheel getal!";
