...
Blockly.Msg.ARD_BUILTIN_LED_TIP = "Accendi o spegni il LED on-board di xrplhook";
...
Blockly.Msg.ARD_FUN_RUN_LOOP = "Loop xrplhook:";
Blockly.Msg.ARD_FUN_RUN_SETUP = "Setup xrplhook:";
Blockly.Msg.ARD_FUN_RUN_TIP = "Definisce le funzioni setup() e loop() di xrplhook.";
...
Blockly.Msg.ARD_TIME_MICROS_TIP = "Restituisce il numero di millisecondi da quando la scheda xrplhook ha iniziato a eseguire il programma. Deve essere salvato in una variabile positiva di tipo long integer";
Blockly.Msg.ARD_TIME_MILLIS = "Tempo passato in questo momento (millisecondi)";
Blockly.Msg.ARD_TIME_MILLIS_TIP = "Restituisce il numero di millisecondi da quando la scheda xrplhook ha iniziato a eseguire il programma. Deve essere salvato in una variabile positiva di tipo long integer";
