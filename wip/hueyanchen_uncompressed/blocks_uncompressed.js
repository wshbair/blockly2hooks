...
Blockly.Blocks.controls_if = {
    ...
    domToMutation: function(a) {
        ...
        for (a = 1; a <= this.elseifCount_; a++) this.appendValueInput("IF" + a).setCheck("Number INT NEGATIVE Variable VAR_INT VAR_UNINT DOUBLE VAR_FLOAT VAR_DOUBLE Aster Boolean".split(" ")).appendField(Blockly.Msg.CONTROLS_IF_MSG_ELSEIF), this.appendStatementInput("DO" + a).appendField(Blockly.Msg.CONTROLS_IF_MSG_THEN);
        this.elseCount_ &&
        ...
        for (a = a.getInputTargetBlock("STACK"); a;) {
            switch (a.type) {
                case "controls_if_elseif":
                    this.elseifCount_++;
                    var b = this.appendValueInput("IF" + this.elseifCount_).setCheck("Number INT NEGATIVE Variable VAR_INT VAR_UNINT DOUBLE VAR_FLOAT VAR_DOUBLE Aster Boolean".split(" ")).appendField(Blockly.Msg.CONTROLS_IF_MSG_ELSEIF),
...
Blockly.Blocks.controls_switch = {
    ...
    domToMutation: function(a) {
        ...
        for (a = 1; a <= this.caseCount_; a++) this.appendValueInput("CASE" + a).appendField(Blockly.Msg.CONTROLS_SWITCH_CASE), this.appendStatementInput("DO" + a).appendField(Blockly.Msg.CONTROLS_IF_MSG_THEN)
    },
    decompose: function(a) {
        var b = Blockly.Block.obtain(a, "controls_switch_switch");
        b.initSvg();
        for (var c = b.getInput("STACK").connection,
                d = 1; d <= this.caseCount_; d++) {
            var e = Blockly.Block.obtain(a, "controls_switch_case");
            e.initSvg();
        ...
        for (a = a.getInputTargetBlock("STACK"); a;) {
            switch (a.type) {
                case "controls_switch_case":
                    this.caseCount_++;
                    b = this.appendValueInput("CASE" + this.caseCount_).setCheck(["Number", "INT", "UNINT", "NEGATIVE", "CHAR"]).appendField(Blockly.Msg.CONTROLS_SWITCH_CASE);
...
Blockly.Blocks.controls_for = {
    init: function() {
        ...
        this.appendDummyInput().appendField(new Blockly.FieldCheckbox("TRUE"), "ORDER").appendField(Blockly.Msg.CONTROLS_FOR_INPUT_ORDER).setAlign(Blockly.ALIGN_RIGHT);
        this.setPreviousStatement(!0);
        this.setNextStatement(!0);
        this.setInputsInline(!0);
        var b = this;
        ...
        this.setTooltip(function() {
            return Blockly.Msg.CONTROLS_FOR_TOOLTIP.replace("%1", b.getFieldValue("VAR"))
        })
    },
    getVars: function() {
        return [this.getFieldValue("VAR")]
    },
    renameVar: function(b, c) {
        Blockly.Names.equals(b, this.getFieldValue("VAR")) && this.setFieldValue(c, "VAR")
    },
    customContextMenu: function(b) {
        if (!this.isCollapsed()) {
            var c = {
                    enabled: !0
                },
                a = this.getFieldValue("VAR");
            c.text = Blockly.Msg.VARIABLES_SET_CREATE_GET.replace("%1", a);
            a = goog.dom.createDom("field", null, a);
            a.setAttribute("name", "VAR");
            a = goog.dom.createDom("block", null, a);
            a.setAttribute("type", "variables_get");
            c.callback = Blockly.ContextMenu.callbackFactory(this,
                a);
            b.push(c)
        }
    },
...
Blockly.Blocks.controls_flow_statements = {
    init: function() {
        ...
        this.setColour(220);
        this.appendDummyInput().appendField(new Blockly.FieldDropdown(b), "FLOW");
        this.setPreviousStatement(!0);
        var a = this;
        this.tag = Blockly.Msg.TAG_LOOP_FLOW;
        this.setTooltip(function() {
            var b = a.getFieldValue("FLOW");
            return {
    ...
    onchange: function() {
        if (this.workspace) {
            var b = !1,
                a = this;
            do {
                if ("controls_for" == a.type || "controls_whileUntil" == a.type || "controls_doWhile" == a.type) {
                    b = !0;
                    break
                }
                a = a.getSurroundParent()
            } while (a);
            b ? this.setWarningText(null) : this.setWarningText(Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING)
        }
    }
};
// Copyright 2012 Google Inc.  Apache License 2.0
...
Blockly.Blocks.math_number = {
    ...
    onchange: function() {
        ...
        0 == a ? this.changeOutput("Number") : 0 === a % 1 ? 0 < a ? null != a && a.endsWith(".0") ? this.changeOutput("DOUBLE") : this.changeOutput("INT") :
...
Blockly.Blocks.math_arithmetic = {
    init: function() {
        ...
        this.setColour(240);
        this.setOutput(!0, "Number Pointer PTR_INT PTR_UNINT PTR_FLOAT PTR_DOUBLE PTR_CHAR".split(" "));
        this.appendValueInput("A").setCheck("Number INT NEGATIVE Variable VAR_INT VAR_UNINT DOUBLE VAR_FLOAT VAR_DOUBLE Aster Pointer PTR_INT PTR_UNINT PTR_FLOAT PTR_DOUBLE PTR_CHAR Macro VAR_CHAR CHAR Array".split(" "));
        this.appendValueInput("B").setCheck("Number INT NEGATIVE Variable VAR_INT VAR_UNINT DOUBLE VAR_FLOAT VAR_DOUBLE Aster Pointer PTR_INT PTR_UNINT PTR_FLOAT PTR_DOUBLE PTR_CHAR Macro VAR_CHAR CHAR Array".split(" ")).appendField(new Blockly.FieldDropdown(a), "OP");
        this.setInputsInline(!0);
        var b = this;
...
Blockly.Blocks.math_convert_type = {
    init: function() {
        ...
        this.setColour(240);
        this.setOutput(!0, "Number Variable VAR_INT VAR_UNINT DOUBLE VAR_FLOAT VAR_DOUBLE VAR_CHAR CHAR".split(" "));
        this.appendValueInput("VAR").setCheck("Number INT NEGATIVE Variable VAR_INT VAR_UNINT DOUBLE VAR_FLOAT VAR_DOUBLE Aster Macro VAR_CHAR CHAR Array".split(" ")).appendField(new Blockly.FieldDropdown(a),
            "NEWTYPE");
        this.setInputsInline(!0);
...
Blockly.Blocks.math_auto_convert_type = {
    init: function() {
        this.setColour(240);
        this.setOutput(!0, "Number Pointer Variable VAR_INT VAR_UNINT DOUBLE VAR_FLOAT VAR_DOUBLE VAR_CHAR CHAR".split(" "));
...
Blockly.Blocks.math_prev_inc_decrement = {
    init: function() {
        ...
        this.setColour(240);
        this.setOutput(!0, ["Number", "Pointer"]);
...
// 2018/06/08 Missing float break
Blockly.Blocks.procedures_return = {
    ...
    getType: function() {
        for (var a = this, b = !1; a.getSurroundParent();)
            if (a = a.getSurroundParent(), "main_block" == a.type || "procedures_defreturn" == a.type) {
                b = !0;
                break
    ...
    onchange: function() {
        ...
        if (this.workspace) {
            for (var a = this, b = !1; a.getSurroundParent();)
                if (a = a.getSurroundParent(), "main_block" == a.type || "procedures_defreturn" == a.type || "procedures_defnoreturn" == a.type) {
                    b = !0;
                    break
                } b && "main_block" == a.type ? Blockly.Blocks.setCheckVariable(this, "int", "VALUE") : b && "procedures_defreturn" == a.type ? (b = a.getFieldValue("DISTS"), a = a.getFieldValue("TYPES"), "array" == b || "variable" == b ? Blockly.Blocks.setCheckVariable(this, a, "VALUE") : Blockly.Blocks.setCheckPointer(this,
                a, "VALUE")) : b && "procedures_defnoreturn" == a.type && this.getInput("VALUE").setCheck("DUMMY_RETURN_VALUE")
        }
    }
};
// 2018/06/19 Update parameters when change name
Blockly.Blocks.procedures_defnoreturn = {
    init: function() {
        this.setColour(300);
        var c = Blockly.Procedures.findLegalName(Blockly.Msg.PROCEDURES_DEFNORETURN_PROCEDURE, this);
        this.appendDummyInput().appendField(Blockly.Msg.PROCEDURES_DEFNORETURN_TITLE).appendField(new Blockly.FieldTextInput(c, Blockly.Procedures.rename), "NAME").appendField("", "PARAMS");
    ...
    updateParams_: function() {
        for (var c = !1, b = {}, a = 0; a < this.arguments_.length; a++) {
            if (b["arg_" +
                    this.arguments_[a].toLowerCase()]) {
                c = !0;
                break
            }
            b["arg_" + this.arguments_[a].toLowerCase()] = !0
        }
        c ? this.setWarningText(Blockly.Msg.PROCEDURES_DEF_DUPLICATE_WARNING) : this.setWarningText(null);
        c = "";
        if (this.arguments_.length)
            for (c = Blockly.Msg.PROCEDURES_BEFORE_PARAMS, a = 0; a < this.arguments_.length; a++) 0 == a ? "v" == this.dist_[a] ? c = c + " " + this.types_[a] + " " + this.arguments_[a] : "a" == this.dist_[a] ? 1 == this.spec_[a][0] ? c = c + " " + this.types_[a] + " " + this.arguments_[a] + "[]" : 2 == this.spec_[a][0] && (c = c + " " + this.types_[a] + " " +
                this.arguments_[a] + "[][" + this.spec_[a][2] + "]") : "p" == this.dist_[a] && (c = c + " " + this.types_[a] + " " + this.spec_[a] + this.arguments_[a]) : "v" == this.dist_[a] ? c = c + ", " + this.types_[a] + " " + this.arguments_[a] : "a" == this.dist_[a] ? 1 == this.spec_[a][0] ? c = c + " " + this.types_[a] + " " + this.arguments_[a] + "[]" : 2 == this.spec_[a][0] && (c = c + " " + this.types_[a] + " " + this.arguments_[a] + "[][" + this.spec_[a][2] + "]") : "p" == this.dist_[a] && (c = c + ", " + this.types_[a] + " " + this.spec_[a] + this.arguments_[a]);
        this.setFieldValue(c, "PARAMS")
    },
    mutationToDom: function() {
        for (var c =
                document.createElement("mutation"), b = 0; b < this.arguments_.length; b++) {
            var a = document.createElement("arg");
            a.setAttribute("name", this.arguments_[b]);
            a.setAttribute("types", this.types_[b]);
            a.setAttribute("dist", this.dist_[b]);
            "a" == this.dist_[b] ? 1 == this.spec_[b][0] ? a.setAttribute("length_1", this.spec_[b][1]) : 2 == this.spec_[b][0] && (a.setAttribute("length_1", this.spec_[b][1]), a.setAttribute("length_2", this.spec_[b][2])) : "p" == this.dist_[b] && a.setAttribute("iteration", this.spec_[b]);
            c.appendChild(a)
        }
        this.getInput("STACK").isVisible() ||
            c.setAttribute("statements", "false");
        return c
    },
    domToMutation: function(c) {
        this.arguments_ = [];
        for (var b = 0, a; a = c.childNodes[b]; b++)
            if ("arg" == a.nodeName.toLowerCase())
                if (this.arguments_.push(a.getAttribute("name")), this.types_.push(a.getAttribute("types")), this.dist_.push(a.getAttribute("dist")), "v" == a.getAttribute("dist")) this.spec_.push(null);
                else if ("a" == a.getAttribute("dist")) {
            var d = a.getAttribute("length_1"),
                e = a.getAttribute("length_2");
            d *= 1;
            e *= 1;
            0 != d && 0 == e ? this.spec_.push([1, a.getAttribute("length_1")]) :
                0 != d && 0 != e && this.spec_.push([2, a.getAttribute("length_1"), a.getAttribute("length_2")])
        } else "p" == a.getAttribute("dist") && this.spec_.push(a.getAttribute("iteration"));
        this.updateParams_();
        c = "false" !== c.getAttribute("statements");
        this.getInput("STACK").setVisible(c)
    },
    decompose: function(c) {
        var b = Blockly.Block.obtain(c, "procedures_mutatorcontainer");
        b.initSvg();
        if (this.getInput("RETURN")) {
            var a = this.getInput("STACK").isVisible();
            b.setFieldValue(a ? "TRUE" : "FALSE", "STATEMENTS")
        } else b.getInput("STATEMENT_INPUT").setVisible(!1);
        Blockly.Procedures.setProcedureName(this.getName());
        a = b.getInput("STACK").connection;
        for (var d = 0; d < this.arguments_.length; d++) {
            if ("v" == this.dist_[d]) {
                var e = Blockly.Block.obtain(c, "procedures_mutatorarg");
                e.initSvg();
                e.setFieldValue(this.arguments_[d], "NAME");
                e.setFieldValue(this.types_[d], "TYPES")
            } else "a" == this.dist_[d] ? (e = Blockly.Block.obtain(c, "procedures_mutatorarg_array"), e.initSvg(), e.setFieldValue(this.arguments_[d], "NAME"), e.setFieldValue(this.types_[d], "TYPES"), 1 == this.spec_[d][0] ? e.setFieldValue(this.spec_[d][1],
                "LENGTH_1") : 2 == this.spec_[d][0] && (e.setFieldValue(this.spec_[d][1], "LENGTH_1"), e.setFieldValue(this.spec_[d][2], "LENGTH_2"))) : "p" == this.dist_[d] && (e = Blockly.Block.obtain(c, "procedures_mutatorarg_pointer"), e.initSvg(), e.setFieldValue(this.arguments_[d], "NAME"), e.setFieldValue(this.types_[d], "TYPES"), e.setFieldValue(this.spec_[d], "ITERATION"));
            e.oldLocation = d;
            a.connect(e.previousConnection);
            a = e.nextConnection
        }
        Blockly.Procedures.mutateCallers(this.getFieldValue("NAME"), this.getFieldValue("TYPES"), this.workspace,
            this.arguments_, this.types_, this.dist_, this.spec_, null);
        return b
    },
    compose: function(c) {
        this.arguments_ = [];
        ...
        this.spec_ = [];
        this.paramIds_ = [];
        for (var b = c.getInputTargetBlock("STACK"); b;) {
            ...
            if ("v" == b.getDist()) this.spec_.push(null);
                ...
                var a = b.getFieldValue("LENGTH_1"),
                    d = b.getFieldValue("LENGTH_2"),
                    e = 1 * a,
                    f = 1 * d;
                0 != e && 0 == f ? this.spec_.push([1,
                    a
                ]) : 0 != e && 0 != f && this.spec_.push([2, a, d])
        ...
        c = c.getFieldValue("STATEMENTS");
        if (null !== c && (c = "TRUE" == c, b = this.getInput("STACK"), b.isVisible() != c)) {
            if (c) b.connection.targetConnection ||
                !this.statementConnection_ || this.statementConnection_.targetConnection || this.statementConnection_.sourceBlock_.workspace != this.workspace ? this.statementConnection_ = null : b.connection.connect(this.statementConnection_);
            else if (this.statementConnection_ = b.connection.targetConnection) a = b.connection.targetBlock(), a.setParent(null), a.bumpNeighbours_();
            b.setVisible(c)
        }
    },
    dispose: function() {
        ...
        Blockly.Procedures.disposeCallers(c, this.workspace);
    ...
    renameVar: function(c, b) {
        for (var a = !1, d = 0; d < this.arguments_.length; d++) Blockly.Names.equals(c, this.arguments_[d]) && (this.arguments_[d] = b, a = !0);
        a && this.updateParams_()
    },
    customContextMenu: function(c) {
        var b = {
                enabled: !0
            },
            a = this.getFieldValue("NAME");
        b.text = Blockly.Msg.PROCEDURES_CREATE_DO.replace("%1", a);
        var d =
            goog.dom.createDom("mutation");
        d.setAttribute("name", a);
        for (var e = 0; e < this.arguments_.length; e++) a = goog.dom.createDom("arg"), a.setAttribute("name", this.arguments_[e]), d.appendChild(a);
        ...
        if (!this.isCollapsed())
            for (e = 0; e < this.arguments_.length; e++) b = {
                enabled: !0
            }, a = this.arguments_[e], b.text = Blockly.Msg.VARIABLES_SET_CREATE_GET.replace("%1", a), d = goog.dom.createDom("field",
    ...
    getParamInfo: function() {
        for (var c = [], b = 0; b < this.arguments_.length; b++) c.push([this.types_[b], this.dist_[b], this.arguments_[b], this.getFieldValue("NAME"), this.getRelativeToSurfaceXY().y, this.spec_[b]]);
        return c
    }
};
...
Blockly.Blocks.procedures_defreturn = {
    init: function() {
        ...
        this.setColour(300);
        var a = Blockly.Procedures.findLegalName(Blockly.Msg.PROCEDURES_DEFRETURN_PROCEDURE,
            this);
        this.appendDummyInput().appendField(Blockly.Msg.PROCEDURES_DEFRETURN_TITLE).appendField(new Blockly.FieldTextInput(a, Blockly.Procedures.rename), "NAME").appendField("", "PARAMS");
        this.appendStatementInput("STACK").appendField(Blockly.Msg.PROCEDURES_DEFRETURN_DO);
        this.appendDummyInput().appendField(Blockly.Msg.PROCEDURES_DEFRETURN_RETURN).appendField(new Blockly.FieldDropdown(c), "TYPES").appendField(new Blockly.FieldDropdown(b), "DISTS").setAlign(Blockly.ALIGN_RIGHT);
    ...
    getProcedureDef: function() {
        ...
        if ("pointer" == this.getFieldValue("DISTS")) return [!0, this.getFieldValue("NAME"), this.getFieldValue("TYPES"), this.arguments_, this.types_, this.dist_, this.spec_, this.getFieldValue("DISTS"), this.getFieldValue("PSPECS")];
        if ("array" == this.getFieldValue("DISTS")) return [!0,
    ...
    getParamInfo: function() {
        var c = [];
        if (this.arguments_.length)
            for (var b = 0; b < this.arguments_.length; b++) c.push([this.types_[b], this.dist_[b], this.arguments_[b], this.getFieldValue("NAME"), this.getRelativeToSurfaceXY().y, this.spec_[b]]);
        return c
    }
};
...
Blockly.Blocks.procedures_mutatorarg = {
    init: function() {
        ...
        this.setColour(300);
        this.appendDummyInput().appendField(Blockly.Msg.PROCEDURES_MUTATORARG_PRETITLE).appendField(new Blockly.FieldDropdown(a), "TYPES").appendField(Blockly.Msg.PROCEDURES_MUTATORARG_TITLE).appendField(new Blockly.FieldTextInput("x",
...
Blockly.Blocks.procedures_mutatorarg_array = {
    init: function() {
        ...
        this.setColour(300);
        this.interpolateMsg(Blockly.Msg.PROCEDURES_MUTATORARG_ARRAY_PRETITLE + " %1 " + Blockly.Msg.VARIABLES_ARRAY_DECLARE_LENGTH + " %2  %3 " + Blockly.Msg.VARIABLES_DECLARE_NAME + " %4 ",
            ["TYPES", new Blockly.FieldDropdown(a)], ["LENGTH_1", new Blockly.FieldTextInput("1")], ["LENGTH_2", new Blockly.FieldTextInput(" ")], ["NAME", new Blockly.FieldTextInput("y", Blockly.Procedures.rename)], Blockly.ALIGN_RIGHT);
        this.setPreviousStatement(!0);
        this.setNextStatement(!0);
        this.setTooltip(Blockly.Msg.PROCEDURES_MUTATORARG_TOOLTIP);
        this.contextMenu = !1
    ...
    getSpec: function() {
        ...
        a *= 1;
        b *= 1;
        if (0 != a && 0 == b) return [1, a];
        if (0 != a && 0 != b) return [2, a, b]
    },
    renameProcedure: function(a, b) {
        if (Blockly.Names.equals(a, this.getFieldValue("NAME"))) {
            var c = Blockly.Procedures.getProcedureName();
...
Blockly.Blocks.procedures_mutatorarg_pointer = {
    init: function() {
        ...
        this.setColour(300);
        this.interpolateMsg(Blockly.Msg.PROCEDURES_MUTATORARG_POINTER_PRETITLE +
            " %1 " + Blockly.Msg.VARIABLES_POINTER_DECLARE_ITERATION + " %2 " + Blockly.Msg.VARIABLES_DECLARE_NAME + " %3 ", ["TYPES", new Blockly.FieldDropdown(a)], ["ITERATION", new Blockly.FieldDropdown(b)], ["NAME", new Blockly.FieldTextInput("z", Blockly.Procedures.rename)], Blockly.ALIGN_RIGHT);
        this.setPreviousStatement(!0);
        this.setNextStatement(!0);
        this.setTooltip(Blockly.Msg.PROCEDURES_MUTATORARG_TOOLTIP);
        this.contextMenu = !1
...
Blockly.Blocks.procedures_callnoreturn = {
    ...
    setProcedureParameters: function(b, a, c, e, d) {
        if (d) {
            if (d.length != b.length) throw "Error: paramNames and paramIds must be the same length.";
            this.quarkArguments_ || (this.quarkConnections_ = {}, b.join("\n") == this.arguments_.join("\n") ? this.quarkArguments_ = d : this.quarkArguments_ = []);
            var k = this.rendered;
            this.rendered = !1;
            for (var f = this.arguments_.length - 1; 0 <= f; f--) {
                var g = this.getInput("ARG" + f);
                if (g) {
                    var h = g.connection.targetConnection;
                    this.quarkConnections_[this.quarkArguments_[f]] = h;
                    this.removeInput("ARG" + f)
                }
            }
            this.arguments_ = [].concat(b);
            this.types_ = [].concat(a);
            this.dist_ = [].concat(c);
            this.spec_ = [].concat(e);
            this.quarkArguments_ = d;
            for (f = 0; f < this.arguments_.length; f++) "v" == this.dist_[f] ? g = this.appendValueInput("ARG" + f).setAlign(Blockly.ALIGN_RIGHT).appendField(this.types_[f]).appendField(this.arguments_[f]) : "a" ==
                ...
                (b = this.quarkArguments_[f], b in this.quarkConnections_ && (h = this.quarkConnections_[b], !h || h.targetConnection || h.sourceBlock_.workspace != this.workspace ? delete this.quarkConnections_[b] : g.connection.connect(h)));
            this.getField_("WITH").setVisible(!!this.arguments_.length);
            (this.rendered = k) && this.render()
        } else this.quarkConnections_ = {}, this.quarkArguments_ = null
    },
    mutationToDom: function() {
        var b = document.createElement("mutation");
        b.setAttribute("name", this.getProcedureCall());
        for (var a = 0; a < this.arguments_.length; a++) {
            var c =
                document.createElement("arg");
            c.setAttribute("name", this.arguments_[a]);
            c.setAttribute("types", this.types_[a]);
            c.setAttribute("dist", this.dist_[a]);
            "a" == this.dist_[a] ? 1 == this.spec_[a][0] ? c.setAttribute("length_1", this.spec_[a][1]) : 2 == this.spec_[a][0] && (c.setAttribute("length_1", this.spec_[a][1]), c.setAttribute("length_2", this.spec_[a][2])) : "p" == this.dist_[a] && c.setAttribute("iteration", this.spec_[a]);
            b.appendChild(c)
        }
        return b
    },
    domToMutation: function(b) {
        ...
        if ((a = Blockly.Procedures.getDefinition(a, this.workspace)) && a.mutator.isVisible()) this.setProcedureParameters(a.arguments_, a.types_, a.dist_, a.spec_, a.paramIds_);
        else {
            this.arguments_ = [];
            this.types_ = [];
            this.dist_ = [];
            ...
            for (var c; c = b.childNodes[a]; a++)
                if ("arg" == c.nodeName.toLowerCase())
                    if (this.arguments_.push(c.getAttribute("name")), this.types_.push(c.getAttribute("types")),
                        this.dist_.push(c.getAttribute("dist")), "v" == c.getAttribute("dist")) this.spec_.push(null);
                    else if ("a" == c.getAttribute("dist")) {
                var e = c.getAttribute("length_1");
                c = c.getAttribute("length_2");
                e *= 1;
                c *= 1;
                0 != e && 0 == c ? this.spec_.push([1, e]) : 0 != e && 0 != c && this.spec_.push([2, e, c])
    ...
    customContextMenu: function(b) {
        ...
        a.text = Blockly.Msg.PROCEDURES_HIGHLIGHT_DEF;
...
// 2018/06/18 add function to return func name
Blockly.Blocks.procedures_callreturn = {
    ...
    onchange: function() {
        for (var c = Blockly.Procedures.allProcedures()[1], b, e = this.getFieldValue("NAME"),
            ...
            var a;
            "int" == b[2] ? a = "INT" : "unsigned int" == b[2] ? a = "UNINT" : "float" == b[2] ? a = "FLOAT" : "double" == b[2] ? a = "DOUBLE" : "char" == b[2] && (a = "CHAR");
            "variable" == b[7] ? a = "VAR_" + a : "pointer" == b[7] ? "*" == b[8] ? a = "PTR_" + a : "**" == b[8] && (a = "DBPTR_" + a) : "array" == b[7] && (c = a, a = ["VAR_" + c, "PTR_" + c, "DBPTR_" + c]);
            this.changeOutput(a)
        }
    }
};
...
// 2019/11/13 rand problem
//Blockly.Blocks.library_stdlib_rand={init:function(){this.setColour(280);this.setOutput(!0);this.interpolateMsg(Blockly.Msg.STDLIB_RAND_TITLE,["VAR","SCOPE",Blockly.ALIGN_RIGHT],Blockly.ALIGN_RIGHT);this.setTooltip(Blockly.Msg.STDLIB_RAND_TOOLTIP);this.tag=Blockly.Msg.TAG_STDLIB_RAND},getScope:function(){var a=this;if(a.getSurroundParent()){for(;"main_block"!=a.type&&"procedures_defnoreturn"!=a.type&&"procedures_defreturn"!=a.type;)a.getSurroundParent()&&(a=a.getSurroundParent());if("main_block"==
//a.type)return a.type;if("procedures_defnoreturn"==a.type||"procedures_defreturn"==a.type)return a.getName()}else return null},onchange:Blockly.Blocks.requireInFunction};
Blockly.Blocks.library_stdlib_rand = {
    ...
    getScope: function() {
        ...
        if (a.getSurroundParent()) {
            for (;
                "main_block" != a.type && "procedures_defnoreturn" != a.type && "procedures_defreturn" != a.type;)
                if (a.getSurroundParent()) a = a.getSurroundParent();
                else break;
            return "main_block" ==
...
Blockly.Blocks.structure_define = {
    ...
    updateParams_: function() {
        for (var a = !1, c = {}, b = 0; b < this.members_.length; b++) {
            if (c["arg_" + this.members_[b].toLowerCase()]) {
                a = !0;
                break
            }
            c["arg_" + this.members_[b].toLowerCase()] = !0
        }
        a ? this.setWarningText(Blockly.Msg.PROCEDURES_DEF_DUPLICATE_WARNING) : this.setWarningText(null);
        a = "";
        if (this.members_.length)
            for (a = Blockly.Msg.PROCEDURES_BEFORE_PARAMS, b = 0; b < this.members_.length; b++) 0 == b ? "v" == this.dist_[b] ? a = a + " " + this.types_[b] + " " + this.members_[b] : "a" == this.dist_[b] ? a = a + " " + this.types_[b] + " " + this.members_[b] + "[" + this.spec_[b] + "]" : "p" == this.dist_[b] && (a = a + " " + this.types_[b] + this.spec_[b] + " " + this.members_[b]) : "v" == this.dist_[b] ? a = a + ", " + this.types_[b] + " " + this.members_[b] : "a" == this.dist_[b] ? a = a + ", " + this.types_[b] + " " + this.members_[b] + "[" + this.spec_[b] + "]" : "p" == this.dist_[b] &&
                (a = a + ", " + this.types_[b] + this.spec_[b] + " " + this.members_[b]);
        this.setFieldValue(a, "PARAMS")
    },
    mutationToDom: function() {
        for (var a = document.createElement("mutation"), c = 0; c < this.members_.length; c++) {
            var b = document.createElement("arg");
            b.setAttribute("name", this.members_[c]);
            b.setAttribute("types", this.types_[c]);
            b.setAttribute("dist", this.dist_[c]);
            "a" == this.dist_[c] ? b.setAttribute("length", this.spec_[c]) : "p" == this.dist_[c] && b.setAttribute("iteration", this.spec_[c]);
            a.appendChild(b)
        }
        return a
    },
    domToMutation: function(a) {
        this.members_ = [];
        for (var c = 0, b; b = a.childNodes[c]; c++) "arg" == b.nodeName.toLowerCase() && (this.members_.push(b.getAttribute("name")), this.types_.push(b.getAttribute("types")), this.dist_.push(b.getAttribute("dist")), "v" == b.getAttribute("dist") ? this.spec_.push(null) : "a" == b.getAttribute("dist") ? this.spec_.push(b.getAttribute("length")) : "p" == b.getAttribute("dist") && this.spec_.push(b.getAttribute("iteration")));
        this.updateParams_()
    },
    decompose: function(a) {
        var c = Blockly.Block.obtain(a, "structure_mutatorcontainer");
        c.initSvg();
        for (var b = c.getInput("STACK").connection, d = 0; d < this.members_.length; d++) {
            if ("v" == this.dist_[d]) {
                var e = Blockly.Block.obtain(a, "structure_mutatormem");
                e.initSvg();
                e.setFieldValue(this.members_[d], "NAME");
                e.setFieldValue(this.types_[d], "TYPES")
            } else "a" == this.dist_[d] ? (e = Blockly.Block.obtain(a, "structure_mutatormem_array"), e.initSvg(), e.setFieldValue(this.members_[d], "NAME"), e.setFieldValue(this.types_[d], "TYPES"), e.setFieldValue(this.spec_[d], "LENGTH")) : "p" == this.dist_[d] && (e = Blockly.Block.obtain(a,
                "structure_mutatormem_pointer"), e.initSvg(), e.setFieldValue(this.members_[d], "NAME"), e.setFieldValue(this.types_[d], "TYPES"), e.setFieldValue(this.spec_[d], "ITERATION"));
            e.oldLocation = d;
            b.connect(e.previousConnection);
            b = e.nextConnection
        }
    ...
    compose: function(a) {
        ...
        this.dist_ = [];
        this.spec_ = [];
        for (var c = a.getInputTargetBlock("STACK"); c;) this.members_.push(c.getFieldValue("NAME")), this.types_.push(c.getFieldValue("TYPES")), this.dist_.push(c.getDist()), "v" == c.getDist() ? this.spec_.push(c.getFieldValue()) : "a" == c.getDist() ? this.spec_.push(c.getFieldValue("LENGTH")) : "p" == c.getDist() && this.spec_.push(c.getFieldValue("ITERATION")), this.paramIds_.push(c.id), c = c.nextConnection && c.nextConnection.targetBlock();
        this.updateParams_();
        ...
        if (null !== a && (a = "TRUE" == a, c = this.getInput("STACK"), c.isVisible() != a)) {
            if (a) c.connection.targetConnection || !this.statementConnection_ || this.statementConnection_.targetConnection || this.statementConnection_.sourceBlock_.workspace != this.workspace ? this.statementConnection_ = null : c.connection.connect(this.statementConnection_);
            else if (this.statementConnection_ = c.connection.targetConnection) {
                var b =
                    c.connection.targetBlock();
                b.setParent(null);
                b.bumpNeighbours_()
            }
            c.setVisible(a)
    ...
    renameVar: function(a, c) {
        for (var b = !1, d = 0; d < this.members_.length; d++) Blockly.Names.equals(a, this.members_[d]) && (this.members_[d] = c, b = !0);
        if (b && (this.updateParams_(),
                this.mutator.isVisible_())) {
            b = this.mutator.workspace_.getAllBlocks();
            d = 0;
            for (var e; e = b[d]; d++) "structure_mutatormem" == e.type && Blockly.Names.equals(a, e.getFieldValue("NAME")) && e.setFieldValue(c, "NAME")
        }
    },
    getDist: function() {
        return ["sd"]
...
Blockly.Blocks.structure_declare = {
    ...
    renameVar: function(a, c) {
        Blockly.Names.equals(a, this.getFieldValue("NAME")) && this.setFieldValue(c, "NAME")
    },
    getDist: function() {
        return ["sn"]
    },
...
Blockly.Blocks.structure_set = {
    ...
    renameProcedure: function(a, c) {
        Blockly.Names.equals(a, this.getStructureCall()) && (this.setFieldValue(c, "NAME"), this.setTooltip((this.outputConnection ? Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP : Blockly.Msg.PROCEDURES_CALLNORETURN_TOOLTIP).replace("%1", c)))
    },
    mutationToDom: function() {
        var a = document.createElement("mutation");
        a.setAttribute("name", this.getStructureCall());
...
Blockly.Blocks.structure_mutatormem_array = {
    init: function() {
        ...
        this.setColour(370);
        this.interpolateMsg(Blockly.Msg.STRUCTURE_MUTATORMEM_ARRAY + "%1 " + Blockly.Msg.VARIABLES_ARRAY_DECLARE_LENGTH + " %2 " + Blockly.Msg.VARIABLES_DECLARE_NAME + " %3 ", ["TYPES", new Blockly.FieldDropdown(a)], ["LENGTH", new Blockly.FieldTextInput("20")], ["NAME", new Blockly.FieldTextInput("z", Blockly.Blocks.CNameValidator)], Blockly.ALIGN_RIGHT);
        this.setPreviousStatement(!0);
        this.setNextStatement(!0);
        this.setTooltip(Blockly.Msg.STRUCTURE_MUTATORARG_TOOLTIP);
        this.contextMenu = !1
...
Blockly.Blocks.structure_mutatormem_pointer = {
    init: function() {
        ...
        this.interpolateMsg(Blockly.Msg.STRUCTURE_MUTATORMEM_POINTER +
            "%1 " + Blockly.Msg.VARIABLES_POINTER_DECLARE_ITERATION + " %2 " + Blockly.Msg.VARIABLES_DECLARE_NAME + " %3 ", ["TYPES", new Blockly.FieldDropdown(a)], ["ITERATION", new Blockly.FieldDropdown(c)], ["NAME", new Blockly.FieldTextInput("y", Blockly.Blocks.CNameValidator)], Blockly.ALIGN_RIGHT);
        this.setPreviousStatement(!0);
        this.setNextStatement(!0);
        this.setTooltip(Blockly.Msg.STRUCTURE_MUTATORARG_TOOLTIP);
        this.contextMenu = !1
...
Blockly.Blocks.text = {
    ...
    newQuote_: function(a) {
        return new Blockly.FieldImage(Blockly.pathToBlockly + "cakeblocklyC/media/" + (a == Blockly.RTL ? "quote1.png" : "quote0.png"), 12, 12, '"')
    }
};
...
// 2018/06/20 Fixed Pointer type check and missing func
Blockly.Blocks.variables_pointer_set = {
    ...
    renameVar: function(a, b) {
        Blockly.Names.equals(a, this.getInputTargetBlock("VAR").getFieldValue("VAR")) && this.getInputTargetBlock("VAR").setFieldValue(b, "VAR")
    },
    customContextMenu: Blockly.Blocks.variables_pointer_get.customContextMenu,
    onchange: function() {
        Blockly.Blocks.requireInFunction(this);
        if (this.getInput("VAR") && this.getInputTargetBlock("VAR"))
            if ("variables_pointer_*" !=
                this.getInputTargetBlock("VAR").type) {
                var a = this.getInputTargetBlock("VAR").getFieldValue("VAR");
                a = Blockly.FieldDropdown.prototype.getTypefromVars(a, 0);
                Blockly.Blocks.setCheckPointer(this, a, "VALUE")
            } else this.getInputTargetBlock("VAR").childBlocks_[0].getVars && (a = this.getInputTargetBlock("VAR").childBlocks_[0].getVars()[0], a = Blockly.FieldDropdown.prototype.getTypefromVars(a, 0), Blockly.Blocks.setCheckVariable(this, a, "VALUE"))
    }
};
...
Blockly.Blocks.variables_array_get = {
    ...
    getIndices: function() {
        ...
        this.getNextBlock() && d--;
        this.getInput("VALUE") && this.getInput("VALUE").connection.targetBlock() && d--;
        switch (d) {
            case 3:
                "math_number" == this.getInput("LENGTH_3").connection.targetBlock().type ? c = this.getInput("LENGTH_3").connection.targetBlock().getFieldValue("NUM") :
                    "variables_get" == this.getInput("LENGTH_3").connection.targetBlock().type ? c = this.getInput("LENGTH_3").connection.targetBlock().getVars() : "math_arithmetic" == this.getInput("LENGTH_3").connection.targetBlock().type && (d = Blockly.cake.math_arithmetic(this.getInput("LENGTH_3").connection.targetBlock()), c = d[0]);
            case 2:
                "math_number" == this.getInput("LENGTH_2").connection.targetBlock().type ? b = this.getInput("LENGTH_2").connection.targetBlock().getFieldValue("NUM") : "variables_get" == this.getInput("LENGTH_2").connection.targetBlock().type ?
                    b = this.getInput("LENGTH_2").connection.targetBlock().getVars() : "math_arithmetic" == this.getInput("LENGTH_2").connection.targetBlock().type && (d = Blockly.cake.math_arithmetic(this.getInput("LENGTH_2").connection.targetBlock()), b = d[0]);
            case 1:
                "math_number" == this.getInput("LENGTH_1").connection.targetBlock().type ? a = this.getInput("LENGTH_1").connection.targetBlock().getFieldValue("NUM") : "variables_get" == this.getInput("LENGTH_1").connection.targetBlock().type ? a = this.getInput("LENGTH_1").connection.targetBlock().getVars() :
    ...
    initIdx: function(a, b, c) {
        0 == a ? this.childBlocks_[0].setFieldValue("0", "NUM") : 0 == b ? this.childBlocks_[1].setFieldValue("0", "NUM") : this.childBlocks_[2].setFieldValue("0", "NUM")
    },
...
Blockly.Blocks.variables_array_set = {
    ...
    onchange: function() {
        ...
        if (this.getFieldValue("VAR")) {
            var a = this.getFieldValue("VAR"),
                b = Blockly.FieldDropdown.prototype.getTypefromVars(a,
                    0);
            a = Blockly.FieldVariableArray.getBlockIdxLength(a);
            var c = this.getInputIdxLength();
            this.getInput("VALUE") && this.getInput("VALUE").connection.targetBlock() && c--;
...
Blockly.Blocks.variables_array_declare = {
    init: function() {
        ...
        this.varInputField = new Blockly.FieldTextInput(b, Blockly.Procedures.rename);
        this.interpolateMsg(Blockly.Msg.VARIABLES_ARRAY_DECLARE_TITLE +
            " %1  " + Blockly.Msg.VARIABLES_DECLARE_NAME + " %2 " + Blockly.Msg.VARIABLES_ARRAY_DECLARE_LENGTH + " %3 %4 " + Blockly.Msg.VARIABLES_ARRAY_DECLARE_VALUE + " %5 ", ["TYPES", new Blockly.FieldDropdown(a)], ["VAR", this.varInputField], ["LENGTH_1", "Number INT Variable VAR_INT VAR_UNINT Aster Macro".split(" "), Blockly.ALIGN_RIGHT], ["LENGTH_2", "Number INT Variable VAR_INT VAR_UNINT Aster Macro".split(" "), Blockly.ALIGN_RIGHT], ["VALUE", ["Array_Initial"], Blockly.ALIGN_RIGHT], Blockly.ALIGN_RIGHT);
        this.setInputsInline(!0);
        this.setPreviousStatement(!0);
        this.setNextStatement(!0);
        this.setTooltip(Blockly.Msg.VARIABLES_DECLARE_TOOLTIP);
...
Blockly.Blocks.variables_array_pointer = {
    init: function() {
        this.setColour(48);
        this.appendDummyInput().appendField(Blockly.Msg.ARRAY_GET_TITLE).appendField(new Blockly.FieldVariableArray(Blockly.Msg.SELECT_MENU, null, this), "VAR");
        this.setOutput(!0, ["Address", "Pointer"]);
        this.setInputsInline(!0);
...
Blockly.Blocks.variables_string_declare = {
    init: function() {
        ...
        this.setColour(48);
        var b = Blockly.Procedures.findLegalName(Blockly.Msg.VARIABLES_STRING_DECLARE_DEFAULT_NAME, this);
        this.interpolateMsg(Blockly.Msg.VARIABLES_STRING_DECLARE_TITLE + " %1  " + Blockly.Msg.VARIABLES_DECLARE_NAME + " %2 " + Blockly.Msg.VARIABLES_STRING_DECLARE_LENGTH + " %3 " + Blockly.Msg.VARIABLES_STRING_DECLARE_VALUE + " %4", ["TYPES", new Blockly.FieldDropdown(a)], ["VAR", new Blockly.FieldTextInput(b,
            Blockly.Procedures.rename)], ["LENGTH_1", "Number INT Variable VAR_INT VAR_UNINT Aster Macro".split(" "), Blockly.ALIGN_RIGHT], ["VALUE", null, Blockly.ALIGN_RIGHT], Blockly.ALIGN_RIGHT);
        this.setInputsInline(!0);
        this.setPreviousStatement(!0);
        this.setNextStatement(!0);
        this.setTooltip(Blockly.Msg.VARIABLES_DECLARE_TOOLTIP);
    ...
    onchange: function() {
        Blockly.Blocks.variablePlaceCheck(this);
        var a = this.getFieldValue("VAR");
        this.oldName != a && (Blockly.Variables.renameVariable(this.oldName,
            a), this.oldName = a)
    },
    getTypes: function() {
        return [this.getFieldValue("TYPES")]
...
Blockly.Blocks.variables_array_initial = {
    init: function() {
        ...
        this.appendValueInput("ADD1");
        this.appendValueInput("ADD2");
        this.setOutput(!0, "Array_Initial");
    ...
    domToMutation: function(a) {
        for (var b = 0; b < this.itemCount_; b++) this.removeInput("ADD" + b);
        this.itemCount_ = parseInt(a.getAttribute("items"), 10);
        for (b = 0; b < this.itemCount_; b++) a = this.appendValueInput("ADD" + b), 0 == b && a.appendField(Blockly.Msg.VARIABLES_ARRAY_INITIAL);
        0 == this.itemCount_ && this.appendDummyInput("EMPTY").appendField(Blockly.Msg.VARIABLES_ARRAY_INITIAL)
    },
    decompose: function(a) {
        var b = Blockly.Block.obtain(a, "array_create_with_container");
        b.initSvg();
        for (var c = b.getInput("STACK").connection, e = 0; e <
            this.itemCount_; e++) {
            var d = Blockly.Block.obtain(a, "array_create_with_item");
            d.initSvg();
            c.connect(d.previousConnection);
            c = d.nextConnection
        }
    ...
    compose: function(a) {
        if (0 == this.itemCount_) this.removeInput("EMPTY");
            ...
            for (var b = this.itemCount_ - 1; 0 <= b; b--) this.removeInput("ADD" + b);
        this.itemCount_ = 0;
        for (a = a.getInputTargetBlock("STACK"); a;) b = this.appendValueInput("ADD" + this.itemCount_), 0 == this.itemCount_ && b.appendField(Blockly.Msg.VARIABLES_ARRAY_INITIAL), a.valueConnection_ && b.connection.connect(a.valueConnection_),
            this.itemCount_++, a = a.nextConnection && a.nextConnection.targetBlock();
        0 == this.itemCount_ && this.appendDummyInput("EMPTY").appendField(Blockly.Msg.VARIABLES_ARRAY_INITIAL)
    },
    saveConnections: function(a) {
        a = a.getInputTargetBlock("STACK");
    ...
    onchange: function() {
        ...
        null != block && "variables_array_declare" == block.type && (this.itemCount_ > block.getIndices()[0] ?
