...
!COMPILED && goog.DEPENDENCIES_ENABLED && (goog.isEdge_ = function() {
        ...
        if (void 0 != goog.global.CLOSURE_BASE_PATH && "string" === typeof goog.global.CLOSURE_BASE_PATH) goog.basePath =
        ...
        if (a.length) {
            for (var e = [], f = 0; f < a.length; f++) {
                ...
                if (!g) throw Error("Unregonized namespace: " +
                    a[f]);
    ...
    function(a) {
        ...
        function b(l, m) {
            ...
            p && (n = ' nonce="' + p + '"');
            n = m ? '<script type="module" crossorigin' + n + ">" + m + "\x3c/script>" : '<script type="module" crossorigin src="' + l + '"' + n + ">\x3c/script>";
...
function module$contents$goog$array_remove(a, b) {
    var c = module$contents$goog$array_indexOf(a, b),
        d;
...
var module$exports$goog$labs$userAgent = {},
    module$contents$goog$labs$userAgent_USE_CLIENT_HINTS_OVERRIDE = "",
    module$contents$goog$labs$userAgent_USE_CLIENT_HINTS = !1;
module$exports$goog$labs$userAgent.USE_CLIENT_HINTS = function() {
    var a = module$contents$goog$labs$userAgent_USE_CLIENT_HINTS_OVERRIDE ? goog.getObjectByName(module$contents$goog$labs$userAgent_USE_CLIENT_HINTS_OVERRIDE) : null;
...
var module$contents$goog$labs$userAgent$util_userAgentInternal = module$contents$goog$labs$userAgent$util_getNativeUserAgentString(),
...
function module$contents$goog$labs$userAgent$browser_useUserAgentBrand() {
    var a = module$contents$goog$labs$userAgent$util_getUserAgentData();
...
var module$contents$goog$labs$userAgent$browser_isOpera = module$contents$goog$labs$userAgent$browser_matchOpera,
    module$contents$goog$labs$userAgent$browser_isIE = module$contents$goog$labs$userAgent$browser_matchIE,
    module$contents$goog$labs$userAgent$browser_isEdge = module$contents$goog$labs$userAgent$browser_matchEdgeHtml,
    module$contents$goog$labs$userAgent$browser_isEdgeChromium = module$contents$goog$labs$userAgent$browser_matchEdgeChromium,
    module$contents$goog$labs$userAgent$browser_isOperaChromium =
    module$contents$goog$labs$userAgent$browser_matchOperaChromium,
    module$contents$goog$labs$userAgent$browser_isFirefox = module$contents$goog$labs$userAgent$browser_matchFirefox,
    module$contents$goog$labs$userAgent$browser_isSafari = module$contents$goog$labs$userAgent$browser_matchSafari,
    module$contents$goog$labs$userAgent$browser_isCoast = module$contents$goog$labs$userAgent$browser_matchCoast,
    module$contents$goog$labs$userAgent$browser_isIosWebview = module$contents$goog$labs$userAgent$browser_matchIosWebview,
    module$contents$goog$labs$userAgent$browser_isChrome = module$contents$goog$labs$userAgent$browser_matchChrome,
    module$contents$goog$labs$userAgent$browser_isAndroidBrowser = module$contents$goog$labs$userAgent$browser_matchAndroidBrowser;
...
function module$contents$goog$labs$userAgent$browser_getVersion() {
    ...
    var b = module$contents$goog$labs$userAgent$util_getUserAgent();
    if (module$contents$goog$labs$userAgent$browser_matchIE()) return module$contents$goog$labs$userAgent$browser_getIEVersion(b);
    b = module$contents$goog$labs$userAgent$util_extractVersionTuples(b);
    var c = {};
    b.forEach(function(e) {
        c[e[0]] = e[1]
    });
    var d = goog.partial(module$contents$goog$object_containsKey, c);
    return module$contents$goog$labs$userAgent$browser_matchOpera() ?
        a(["Version", "Opera"]) : module$contents$goog$labs$userAgent$browser_matchEdgeHtml() ? a(["Edge"]) : module$contents$goog$labs$userAgent$browser_matchEdgeChromium() ? a(["Edg"]) : module$contents$goog$labs$userAgent$browser_matchChrome() ? a(["Chrome", "CriOS", "HeadlessChrome"]) : (b = b[2]) && b[1] || ""
}
...
function module$contents$goog$labs$userAgent$platform_getVersion() {
    ...
    module$contents$goog$labs$userAgent$platform_isWindows() ? (b = /Windows (?:NT|Phone) ([0-9.]+)/, b = (a = b.exec(a)) ? a[1] : "0.0") : module$contents$goog$labs$userAgent$platform_isIos() ? (b = /(?:iPhone|iPod|iPad|CPU)\s+OS\s+(\S+)/, b = (a = b.exec(a)) && a[1].replace(/_/g, ".")) : module$contents$goog$labs$userAgent$platform_isMacintosh() ? (b = /Mac OS X ([0-9_.]+)/, b = (a = b.exec(a)) ? a[1].replace(/_/g,
        ".") : "10") : module$contents$goog$labs$userAgent$platform_isKaiOS() ? (b = /(?:KaiOS)\/(\S+)/i, b = (a = b.exec(a)) && a[1]) : module$contents$goog$labs$userAgent$platform_isAndroid() ? (b = /Android\s+([^\);]+)(\)|;)/, b = (a = b.exec(a)) && a[1]) : module$contents$goog$labs$userAgent$platform_isChromeOS() && (b = /(?:CrOS\s+(?:i686|x86_64)\s+([0-9.]+))/, b = (a = b.exec(a)) && a[1]);
    return b || ""
}
...
module$contents$goog$async$WorkQueue_WorkQueue.prototype.add = function(a, b) {
    var c = this.getUnusedItem_();
    c.set(a, b);
    this.workTail_ ? this.workTail_.next = c : ((0, goog.asserts.assert)(!this.workHead_), this.workHead_ = c);
    this.workTail_ = c
};
...
module$contents$goog$async$WorkQueue_WorkQueue.prototype.returnUnused = function(a) {
    module$contents$goog$async$WorkQueue_WorkQueue.freelist_.put(a)
};
...
function module$contents$goog$html$SafeStyle_sanitizePropertyValueString(a) {
    ...
    if (module$contents$goog$html$SafeStyle_VALUE_RE.test(b)) {
        ...
        if (!module$contents$goog$html$SafeStyle_hasBalancedQuotes(a)) return (0, goog.asserts.fail)("String value requires balanced quotes, got: " + a), module$contents$goog$html$SafeStyle_SafeStyle.INNOCUOUS_STRING;
    ...
    } else return (0, goog.asserts.fail)("String value allows only " +
        module$contents$goog$html$SafeStyle_VALUE_ALLOWED_CHARS + " and simple functions, got: " + a), module$contents$goog$html$SafeStyle_SafeStyle.INNOCUOUS_STRING;
...
var module$contents$goog$html$SafeStyle_VALUE_ALLOWED_CHARS = "[-,.\"'%_!# a-zA-Z0-9\\[\\]]",
    ...
    module$contents$goog$html$SafeStyle_ALLOWED_FUNCTIONS = "calc cubic-bezier fit-content hsl hsla linear-gradient matrix minmax repeat rgb rgba (rotate|scale|translate)(X|Y|Z|3d)? var".split(" "),
    module$contents$goog$html$SafeStyle_FUNCTIONS_RE = new RegExp("\\b(" + module$contents$goog$html$SafeStyle_ALLOWED_FUNCTIONS.join("|") + ")\\([-+*/0-9a-z.%\\[\\], ]+\\)", "g"),
...
module$contents$goog$html$SafeStyleSheet_SafeStyleSheet.createRule = function(a, b) {
    ...
    c = a + "{" + module$contents$goog$html$SafeStyle_SafeStyle.unwrap(b).replace(/</g, "\\3C ") + "}";
...
var module$contents$goog$html$SafeHtml_CONSTRUCTOR_TOKEN_PRIVATE = {},
    module$contents$goog$html$SafeHtml_SafeHtml = function(a, b, c) {
...
module$contents$goog$html$SafeHtml_SafeHtml.createIframe = function(a, b, c, d) {
    ...
    a = module$contents$goog$html$SafeHtml_SafeHtml.combineAttributes(e, {
        sandbox: ""
    }, c);
...
module$contents$goog$html$SafeHtml_SafeHtml.createSandboxIframe = function(a, b, c, d) {
    ...
    return module$contents$goog$html$SafeHtml_SafeHtml.createSafeHtmlTagSecurityPrivateDoNotAccessOrElse("iframe",
        a, d)
};
...
module$contents$goog$html$SafeHtml_SafeHtml.createScriptSrc = function(a, b) {
    ...
    var c = module$contents$goog$html$SafeHtml_SafeHtml.combineAttributes({
        src: a
    }, {}, b);
    return module$contents$goog$html$SafeHtml_SafeHtml.createSafeHtmlTagSecurityPrivateDoNotAccessOrElse("script", c)
};
module$contents$goog$html$SafeHtml_SafeHtml.createScript = function(a, b) {
    ...
    c = module$contents$goog$html$SafeHtml_SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(c,
        goog.i18n.bidi.Dir.NEUTRAL);
    return module$contents$goog$html$SafeHtml_SafeHtml.createSafeHtmlTagSecurityPrivateDoNotAccessOrElse("script", b, c)
};
module$contents$goog$html$SafeHtml_SafeHtml.createStyle = function(a, b) {
    var c = module$contents$goog$html$SafeHtml_SafeHtml.combineAttributes({
        ...
        d = "";
    a = module$contents$goog$array_concat(a);
    for (var e = 0; e < a.length; e++) d += module$contents$goog$html$SafeStyleSheet_SafeStyleSheet.unwrap(a[e]);
    d = module$contents$goog$html$SafeHtml_SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(d, goog.i18n.bidi.Dir.NEUTRAL);
...
module$contents$goog$html$SafeHtml_SafeHtml.createMetaRefresh = function(a, b) {
    ...
    (module$contents$goog$labs$userAgent$browser_matchIE() || module$contents$goog$labs$userAgent$browser_matchEdgeHtml()) && goog.string.internal.contains(c, ";") && (c = "'" + c.replace(/'/g, "%27") + "'");
...
module$contents$goog$html$SafeHtml_SafeHtml.join = function(a, b) {
    var c = module$contents$goog$html$SafeHtml_SafeHtml.htmlEscape(a),
        d = c.getDirection(),
        e = [],
        f = function(g) {
            Array.isArray(g) ? g.forEach(f) : (g = module$contents$goog$html$SafeHtml_SafeHtml.htmlEscape(g), e.push(module$contents$goog$html$SafeHtml_SafeHtml.unwrap(g)), g = g.getDirection(), d == goog.i18n.bidi.Dir.NEUTRAL ? d = g : g != goog.i18n.bidi.Dir.NEUTRAL && d != g && (d = null))
        };
    b.forEach(f);
    return module$contents$goog$html$SafeHtml_SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(e.join(module$contents$goog$html$SafeHtml_SafeHtml.unwrap(c)),
        d)
};
...
module$contents$goog$html$SafeHtml_SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse = function(a, b) {
    ...
    return new module$contents$goog$html$SafeHtml_SafeHtml(c, b, module$contents$goog$html$SafeHtml_CONSTRUCTOR_TOKEN_PRIVATE)
};
    ...
    if (c)
        for (var f in c)
            if (Object.prototype.hasOwnProperty.call(c, f)) {
                var g = f.toLowerCase();
                if (g in a) throw Error(module$contents$goog$html$SafeHtml_SafeHtml.ENABLE_ERROR_MESSAGES ?
...
function module$contents$goog$html$SafeHtml_getAttrNameAndValue(a, b, c) {
    if (c instanceof goog.string.Const) c = goog.string.Const.unwrap(c);
        ...
        if (/^on/i.test(b)) throw Error(module$contents$goog$html$SafeHtml_SafeHtml.ENABLE_ERROR_MESSAGES ? 'Attribute "' +
            b + '" requires goog.string.Const value, "' + c + '" given.' : "");
        ...
        else throw Error(module$contents$goog$html$SafeHtml_SafeHtml.ENABLE_ERROR_MESSAGES ? 'Attribute "' + b + '" on tag "' + a + '" requires goog.html.SafeUrl, goog.string.Const, or string, value "' +
            c + '" given.' : "");
    }
...
function module$contents$goog$html$SafeHtml_getStyleValue(a) {
    if (!goog.isObject(a)) throw Error(module$contents$goog$html$SafeHtml_SafeHtml.ENABLE_ERROR_MESSAGES ? 'The "style" attribute requires goog.html.SafeStyle or map of style properties, ' + typeof a + " given: " + a : "");
...
goog.dom.safe.getNonce_ = function(a, b) {
    ...
    return c.querySelector ? (c = c.querySelector(a)) && (c = c.nonce || c.getAttribute("nonce")) && goog.dom.safe.NONCE_PATTERN_.test(c) ? c : "" : ""
};
goog.math = {};
...
goog.dom.createDom_ = function(a, b) {
    var c = b[1],
        d = goog.dom.createElement_(a, String(b[0]));
    c && ("string" === typeof c ? d.className = c : Array.isArray(c) ? d.className = c.join(" ") : goog.dom.setProperties(d, c));
    2 < b.length && goog.dom.append_(a, d, b, 2);
    return d
};
...
goog.dom.copyContents = function(a, b) {
    ...
    for (goog.dom.removeChildren(a); c.length;) a.appendChild(c[0])
};
...
goog.dom.hasNonZeroBoundingRect_ = function(a) {
    a = "function" !== typeof a.getBoundingClientRect || goog.userAgent.IE && null == a.parentElement ? {
...
goog.async.nextTick = function(a, b, c) {
    ...
    "function" === typeof goog.global.setImmediate && (c || goog.async.nextTick.useSetImmediate_()) ? goog.global.setImmediate(d) : (goog.async.nextTick.setImmediate_ || (goog.async.nextTick.setImmediate_ = goog.async.nextTick.getSetImmediateEmulator_()), goog.async.nextTick.setImmediate_(d))
};
...
goog.async.nextTick.getSetImmediateEmulator_ = function() {
    ...
    "undefined" === typeof a && "undefined" !== typeof window && window.postMessage && window.addEventListener && !module$contents$goog$labs$userAgent$engine_isPresto() && (a = function() {
        var e = goog.dom.createElement(goog.dom.TagName.IFRAME);
    ...
    if ("undefined" !== typeof a && !module$contents$goog$labs$userAgent$browser_matchIE()) {
        var b = new a,
            c = {},
            d = c;
...
goog.async.run.processWorkQueue = function() {
    for (var a; a = goog.async.run.workQueue_.remove();) {
        try {
            ...
            module$contents$goog$async$throwException_throwException(b)
        }
...
goog.Promise = function(a, b) {
    ...
    if (a != goog.nullFunction) try {
        ...
        a.call(b, function(d) {
            ...
            if (goog.DEBUG && !(d instanceof goog.Promise.CancellationError)) try {
                if (d instanceof Error) throw d;
                throw Error("Promise rejected.");
            } catch (e) {}
            c.resolve_(goog.Promise.State_.REJECTED, d)
        })
    } catch (d) {
...
goog.Promise.withResolver = function() {
    var a, b, c = new goog.Promise(function(d, e) {
        a = d;
        b = e
    });
...
goog.Promise.prototype.then = function(a, b, c) {
    ...
    return this.addChildPromise_("function" === typeof a ? a : null, "function" === typeof b ? b : null, c)
};
...
goog.Promise.prototype.addChildPromise_ = function(a, b, c) {
    ...
    d.child = new goog.Promise(function(e, f) {
        ...
        d.onRejected = b ? function(g) {
            try {
                var h = b.call(c, g);
                void 0 === h && g instanceof goog.Promise.CancellationError ? f(g) : e(h)
            } catch (k) {
                f(k)
            }
        } : f
...
goog.Promise.maybeThen_ = function(a, b, c, d) {
    ...
    if (goog.isObject(a)) try {
        var e = a.then;
        if ("function" === typeof e) return goog.Promise.tryThen_(a, e, b, c, d), !0
    } catch (f) {
        return c.call(d, f), !0
    }
    return !1
...
goog.Promise.CancellationError = function(a) {
    module$contents$goog$debug$Error_DebugError.call(this, a);
...
goog.debug.deepExpose = function(a, b) {
    var c = [],
        ...
        f = function(h, k) {
            var l = k + "  ";
            try {
                if (void 0 === h) c.push("undefined");
                else if (null === h) c.push("NULL");
                else if ("string" === typeof h) c.push('"' + h.replace(/\n/g, "\n" + k) + '"');
                else if ("function" === typeof h) c.push(String(h).replace(/\n/g, "\n" + k));
                else if (goog.isObject(h)) {
                    goog.hasUid(h) || d.push(h);
                    var m = goog.getUid(h);
                    if (e[m]) c.push("*** reference loop detected (id=" + m + ") ***");
                        ...
                        c.push("{");
                        for (var n in h)
                            if (b || "function" !== typeof h[n]) c.push("\n"),
                                c.push(l), c.push(n + " = "), f(h[n], l);
                        c.push("\n" + k + "}");
                        delete e[m]
                    }
                } else c.push(h)
...
goog.debug.serializeErrorStack_ = function(a, b) {
    ...
    var c = a.stack || "",
        d = a.cause;
    d && !b[goog.debug.serializeErrorAsKey_(d)] && (c += "\nCaused by: ", d.stack && 0 == d.stack.indexOf(d.toString()) || (c += "string" === typeof d ? d : d.message + "\n"), c += goog.debug.serializeErrorStack_(d, b));
    return c
};
        ...
        for (var d = a.arguments, e = 0; d && e < d.length; e++) {
            ...
            switch (typeof f) {
                ...
                case "boolean":
                    ...
                    break;
                case "function":
                    f = (f = goog.debug.getFunctionName(f)) ?
                        f : "[fn]";
                    break;
                default:
                    f = typeof f
...
goog.events.BrowserFeature = {
    HAS_W3C_BUTTON: !0,
    HAS_W3C_EVENT_SUPPORT: !0,
    SET_KEY_CODE_TO_PREVENT_DEFAULT: !1,
    HAS_NAVIGATOR_ONLINE_PROPERTY: !0,
    HAS_HTML5_NETWORK_EVENT_SUPPORT: !0,
    HTML5_NETWORK_EVENTS_FIRE_ON_BODY: !1,
    ...
    MSPOINTER_EVENTS: "MSPointerEvent" in
        goog.global && !(!goog.global.navigator || !goog.global.navigator.msPointerEnabled),
...
goog.events.Listenable.prototype.listen = function(a, b, c, d) {};
goog.events.Listenable.prototype.listenOnce = function(a, b, c, d) {};
goog.events.Listenable.prototype.unlisten = function(a, b, c, d) {};
goog.events.Listenable.prototype.unlistenByKey = function(a) {};
goog.events.Listenable.prototype.dispatchEvent = function(a) {};
goog.events.Listenable.prototype.removeAllListeners = function(a) {};
goog.events.Listenable.prototype.getParentEventTarget = function() {};
goog.events.Listenable.prototype.fireListeners = function(a, b, c) {};
goog.events.Listenable.prototype.getListeners = function(a, b) {};
goog.events.Listenable.prototype.getListener = function(a, b, c, d) {};
goog.events.Listenable.prototype.hasListener = function(a, b) {};
...
goog.events.EventTarget.dispatchEventInternal_ = function(a, b, c) {
    ...
    e = !0;
    if (c)
        for (var f = c.length - 1; !b.hasPropagationStopped() && 0 <= f; f--) {
...
goog.Timer.callOnce = function(a, b, c) {
    if ("function" === typeof a) c && (a = goog.bind(a, c));
...
goog.style.installSafeStyleSheet = function(a, b) {
    ...
    d = c.getElementsByTagNameAndClass(goog.dom.TagName.HEAD)[0];
    if (!d) {
        var e = c.getElementsByTagNameAndClass(goog.dom.TagName.BODY)[0];
        d = c.createDom(goog.dom.TagName.HEAD);
        e.parentNode.insertBefore(d, e)
    }
    e = c.createDom(goog.dom.TagName.STYLE);
    var f = goog.dom.safe.getStyleNonce();
...
goog.style.setSafeStyleSheet = function(a, b) {
    var c = module$contents$goog$html$SafeStyleSheet_SafeStyleSheet.unwrap(b);
    goog.userAgent.IE && void 0 !== a.cssText ? a.cssText = c : goog.global.trustedTypes ? goog.dom.setTextContent(a, c) : a.innerHTML = c
};
goog.style.setPreWrap = function(a) {
    a.style.whiteSpace = goog.userAgent.GECKO ? "-moz-pre-wrap" : "pre-wrap"
};
...
goog.style.isUnselectable = function(a) {
    return goog.style.unselectableStyle_ ? "none" == a.style[goog.style.unselectableStyle_].toLowerCase() : goog.userAgent.IE ? "on" == a.getAttribute("unselectable") : !1
};
goog.style.setUnselectable = function(a, b, c) {
    ...
    } else if (goog.userAgent.IE && (b = b ? "on" : "", a.setAttribute("unselectable", b), c))
...
goog.style.setBorderBoxSize = function(a, b) {
    ...
    if (!goog.userAgent.IE || goog.userAgent.isVersionOrHigher("10") || d) goog.style.setBoxSizingSize_(a, b, "border-box");
    else if (c = a.style, d) {
...
goog.style.setContentBoxSize = function(a, b) {
    var c = goog.dom.getOwnerDocument(a),
        d = goog.dom.getDomHelper(c).isCss1CompatMode();
    if (!goog.userAgent.IE || goog.userAgent.isVersionOrHigher("10") || d) goog.style.setBoxSizingSize_(a, b, "content-box");
...
goog.style.toStyleAttribute = function(a) {
    var b = [];
    module$contents$goog$object_forEach(a, function(c, d) {
...
goog.a11y.aria.datatables.getDefaultValuesMap = function() {
    goog.a11y.aria.DefaultStateValueMap_ || (goog.a11y.aria.DefaultStateValueMap_ = module$contents$goog$object_create(goog.a11y.aria.State.ATOMIC, !1, goog.a11y.aria.State.AUTOCOMPLETE, "none", goog.a11y.aria.State.DROPEFFECT, "none", goog.a11y.aria.State.HASPOPUP, !1, goog.a11y.aria.State.LIVE, "off", goog.a11y.aria.State.MULTILINE, !1, goog.a11y.aria.State.MULTISELECTABLE, !1, goog.a11y.aria.State.ORIENTATION, "vertical", goog.a11y.aria.State.READONLY, !1, goog.a11y.aria.State.RELEVANT,
...
goog.a11y.aria.setRole = function(a, b) {
    b ? (goog.asserts.ENABLE_ASSERTS && goog.asserts.assert(module$contents$goog$object_containsValue(goog.a11y.aria.Role, b), "No such ARIA role " + b), a.setAttribute(goog.a11y.aria.ROLE_ATTRIBUTE_, b)) : goog.a11y.aria.removeRole(a)
};
...
goog.a11y.aria.assertRoleIsSetInternalUtil = function(a, b) {
    if (!goog.a11y.aria.TAGS_WITH_ASSUMED_ROLES_[a.tagName]) {
        ...
        goog.asserts.assert(module$contents$goog$array_contains(b, c), 'Non existing or incorrect role set for element.The role set is "' + c + '". The role should be any of "' + b + '". Check the ARIA specification for more details http://www.w3.org/TR/wai-aria/roles.')
    }
};
...
goog.a11y.aria.isContainerRole = function(a) {
    ...
    return module$contents$goog$array_contains(goog.a11y.aria.CONTAINER_ROLES_, a)
};
goog.a11y.aria.splitStringOnWhitespace_ = function(a) {
    return a ? a.split(/\s+/) : []
};
goog.a11y.aria.getAriaAttributeName_ = function(a) {
    goog.asserts.ENABLE_ASSERTS && (goog.asserts.assert(a, "ARIA attribute cannot be empty."), goog.asserts.assert(module$contents$goog$object_containsValue(goog.a11y.aria.State, a), "No such ARIA attribute " + a));
...
goog.dom.classlist.contains = function(a, b) {
    return goog.dom.classlist.ALWAYS_USE_DOM_TOKEN_LIST || a.classList ? a.classList.contains(b) : module$contents$goog$array_contains(goog.dom.classlist.get(a), b)
};
...
goog.dom.classlist.addAll = function(a, b) {
    if (goog.dom.classlist.ALWAYS_USE_DOM_TOKEN_LIST || a.classList) Array.prototype.forEach.call(b, function(f) {
        goog.dom.classlist.add(a, f)
    });
    else {
        var c = {};
        Array.prototype.forEach.call(goog.dom.classlist.get(a), function(f) {
            c[f] = !0
        });
...
goog.dom.classlist.remove = function(a, b) {
    goog.dom.classlist.ALWAYS_USE_DOM_TOKEN_LIST || a.classList ? a.classList.remove(b) : goog.dom.classlist.contains(a, b) && goog.dom.classlist.set(a, Array.prototype.filter.call(goog.dom.classlist.get(a), function(c) {
        return c != b
    }).join(" "))
};
goog.dom.classlist.removeAll = function(a, b) {
    goog.dom.classlist.ALWAYS_USE_DOM_TOKEN_LIST || a.classList ? Array.prototype.forEach.call(b, function(c) {
        goog.dom.classlist.remove(a, c)
    }) : goog.dom.classlist.set(a, Array.prototype.filter.call(goog.dom.classlist.get(a), function(c) {
        return !module$contents$goog$array_contains(b, c)
    }).join(" "))
};
...
goog.events.KeyHandler.prototype.handleKeyDown_ = function(a) {
    ...
    goog.events.KeyCodes.firesKeyPressEvent(a.keyCode, this.lastKey_, a.shiftKey, a.ctrlKey, a.altKey, a.metaKey) ? (this.keyCode_ = goog.events.KeyCodes.normalizeKeyCode(a.keyCode), goog.events.KeyHandler.SAVE_ALT_FOR_KEYPRESS_ && (this.altKey_ = a.altKey)) : this.handleEvent(a)
};
...
goog.events.KeyHandler.prototype.handleEvent = function(a) {
    ...
    } else(goog.userAgent.WEBKIT || goog.userAgent.EDGE) && a.type == goog.events.EventType.KEYPRESS ? (d = this.keyCode_, e = 0 <= b.charCode && 63232 > b.charCode && goog.events.KeyCodes.isCharacterKey(d) ? b.charCode : 0) : (a.type == goog.events.EventType.KEYPRESS ? (goog.events.KeyHandler.SAVE_ALT_FOR_KEYPRESS_ &&
        (c = this.altKey_), b.keyCode == b.charCode ? 32 > b.keyCode ? (d = b.keyCode, e = 0) : (d = this.keyCode_, e = b.charCode) : (d = b.keyCode || this.keyCode_, e = b.charCode || 0)) : (d = b.keyCode || this.keyCode_, e = b.charCode || 0), goog.userAgent.MAC && e == goog.events.KeyCodes.QUESTION_MARK && d == goog.events.KeyCodes.WIN_KEY && (d = goog.events.KeyCodes.SLASH));
    var f = d = goog.events.KeyCodes.normalizeKeyCode(d);
    d ? 63232 <= d && d in goog.events.KeyHandler.safariKey_ ? f = goog.events.KeyHandler.safariKey_[d] : 25 == d && a.shiftKey && (f = 9) : b.keyIdentifier && b.keyIdentifier in
        goog.events.KeyHandler.keyIdentifier_ && (f = goog.events.KeyHandler.keyIdentifier_[b.keyIdentifier]);
    if (!goog.userAgent.GECKO || a.type != goog.events.EventType.KEYPRESS || goog.events.KeyCodes.firesKeyPressEvent(f, this.lastKey_, a.shiftKey, a.ctrlKey, c, a.metaKey)) a = f == this.lastKey_, this.lastKey_ = f, b = new goog.events.KeyEvent(f, e, a, b), b.altKey = c, this.dispatchEvent(b)
};
...
var $opensource$closure$goog$log$log$classdecl$var0 = function(a, b) {
    this.name = a;
    this.value = b
};
$opensource$closure$goog$log$log$classdecl$var0.prototype.toString = function() {
    return this.name
};
goog.log.Level = $opensource$closure$goog$log$log$classdecl$var0;
...
goog.log.Level.createPredefinedLevelsCache_ = function() {
    ...
    for (var a = 0, b; b = goog.log.Level.PREDEFINED_LEVELS[a]; a++) goog.log.Level.predefinedLevelsCache_[b.value] = b, goog.log.Level.predefinedLevelsCache_[b.name] = b
};
...
var $opensource$closure$goog$log$log$classdecl$var1 = function() {};
$opensource$closure$goog$log$log$classdecl$var1.prototype.getName = function() {};
goog.log.Logger = $opensource$closure$goog$log$log$classdecl$var1;
goog.log.Logger.Level = goog.log.Level;
var $opensource$closure$goog$log$log$classdecl$var2 = function(a) {
    this.capacity_ = "number" === typeof a ? a : goog.log.LogBuffer.CAPACITY;
    this.clear()
};
$opensource$closure$goog$log$log$classdecl$var2.prototype.addRecord = function(a, b, c) {
...
$opensource$closure$goog$log$log$classdecl$var2.prototype.forEachRecord = function(a) {
    var b = this.buffer_;
    if (b[0]) {
        var c = this.curIndex_,
            d = this.isFull_ ? c : -1;
        do d = (d + 1) % this.capacity_, a(b[d]); while (d !== c)
    }
};
$opensource$closure$goog$log$log$classdecl$var2.prototype.isBufferingEnabled = function() {
    return 0 < this.capacity_
};
$opensource$closure$goog$log$log$classdecl$var2.prototype.isFull = function() {
    return this.isFull_
};
$opensource$closure$goog$log$log$classdecl$var2.prototype.clear = function() {
    this.buffer_ = Array(this.capacity_);
    this.curIndex_ = -1;
    this.isFull_ = !1
};
goog.log.LogBuffer = $opensource$closure$goog$log$log$classdecl$var2;
...
var $opensource$closure$goog$log$log$classdecl$var3 = function(a, b, c, d, e) {
    this.exception_ = void 0;
    this.reset(a || goog.log.Level.OFF, b, c, d, e)
};
$opensource$closure$goog$log$log$classdecl$var3.prototype.reset = function(a, b, c, d, e) {
...
$opensource$closure$goog$log$log$classdecl$var3.prototype.getLoggerName = function() {
    return this.loggerName_
};
$opensource$closure$goog$log$log$classdecl$var3.prototype.setLoggerName = function(a) {
    this.loggerName_ = a
};
$opensource$closure$goog$log$log$classdecl$var3.prototype.getException = function() {
    return this.exception_
};
$opensource$closure$goog$log$log$classdecl$var3.prototype.setException = function(a) {
    this.exception_ = a
};
$opensource$closure$goog$log$log$classdecl$var3.prototype.getLevel = function() {
    return this.level_
};
$opensource$closure$goog$log$log$classdecl$var3.prototype.setLevel = function(a) {
    this.level_ = a
};
$opensource$closure$goog$log$log$classdecl$var3.prototype.getMessage = function() {
    return this.msg_
};
$opensource$closure$goog$log$log$classdecl$var3.prototype.setMessage = function(a) {
    this.msg_ = a
};
$opensource$closure$goog$log$log$classdecl$var3.prototype.getMillis = function() {
    return this.time_
};
$opensource$closure$goog$log$log$classdecl$var3.prototype.setMillis = function(a) {
    this.time_ = a
};
$opensource$closure$goog$log$log$classdecl$var3.prototype.getSequenceNumber = function() {
    return this.sequenceNumber_
};
goog.log.LogRecord = $opensource$closure$goog$log$log$classdecl$var3;
goog.log.LogRecord.nextSequenceNumber_ = 0;
var $opensource$closure$goog$log$log$classdecl$var4 = function(a, b) {
    this.level = null;
    this.handlers = [];
...
$opensource$closure$goog$log$log$classdecl$var4.prototype.getEffectiveLevel = function() {
    if (this.level) return this.level;
    if (this.parent) return this.parent.getEffectiveLevel();
    goog.asserts.fail("Root logger has no level set.");
    return goog.log.Level.OFF
};
$opensource$closure$goog$log$log$classdecl$var4.prototype.publish = function(a) {
    for (var b = this; b;) b.handlers.forEach(function(c) {
        c(a)
    }), b = b.parent
};
goog.log.LogRegistryEntry_ = $opensource$closure$goog$log$log$classdecl$var4;
var $opensource$closure$goog$log$log$classdecl$var5 = function() {
    this.entries = {};
...
$opensource$closure$goog$log$log$classdecl$var5.prototype.getLogRegistryEntry = function(a, b) {
...
$opensource$closure$goog$log$log$classdecl$var5.prototype.getAllLoggers = function() {
    var a = this;
    return Object.keys(this.entries).map(function(b) {
        return a.entries[b].logger
    })
};
goog.log.LogRegistry_ = $opensource$closure$goog$log$log$classdecl$var5;
...
goog.log.removeHandler = function(a, b) {
    if (goog.log.ENABLED && a) {
        var c = goog.log.LogRegistry_.getInstance().getLogRegistryEntry(a.getName()),
            d = c.handlers.indexOf(b);
        if (-1 !== d) return c.handlers.splice(d, 1), !0
    }
    return !1
};
...
goog.log.getEffectiveLevel = function(a) {
    return goog.log.ENABLED && a ? goog.log.LogRegistry_.getInstance().getLogRegistryEntry(a.getName()).getEffectiveLevel() : goog.log.Level.OFF
};
...
goog.log.publishLogRecord = function(a, b) {
    goog.log.ENABLED && a && goog.log.isLoggable(a, b.getLevel()) && goog.log.LogRegistry_.getInstance().getLogRegistryEntry(a.getName()).publish(b)
};
...
goog.ui.Component.prototype.setId = function(a) {
    this.parent_ && this.parent_.childIndex_ && (module$contents$goog$object_remove(this.parent_.childIndex_, this.id_), module$contents$goog$object_add(this.parent_.childIndex_, a, this));
    this.id_ = a
};
...
goog.ui.Component.prototype.addChildAt = function(a, b, c) {
    ...
    a.getParent() == this ? (module$contents$goog$object_set(this.childIndex_, a.getId(), a), module$contents$goog$array_remove(this.children_,
        a)) : module$contents$goog$object_add(this.childIndex_, a.getId(), a);
    a.setParent(this);
    module$contents$goog$array_insertAt(this.children_, a, b);
...
goog.ui.Component.prototype.getChild = function(a) {
    return this.childIndex_ && a ? module$contents$goog$object_get(this.childIndex_, a) || null : null
};
...
goog.ui.Component.prototype.forEachChild = function(a, b) {
    this.children_ && this.children_.forEach(a, b)
};
goog.ui.Component.prototype.indexOfChild = function(a) {
    return this.children_ && a ? this.children_.indexOf(a) : -1
};
goog.ui.Component.prototype.removeChild = function(a, b) {
    if (a) {
        var c = "string" === typeof a ? a : a.getId();
        a = this.getChild(c);
        c && a && (module$contents$goog$object_remove(this.childIndex_, c), module$contents$goog$array_remove(this.children_, a), b && (a.exitDocument(), a.element_ && goog.dom.removeNode(a.element_)), a.setParent(null))
    }
...
goog.ui.tree.BaseNode = function(a, b, c) {
    ...
    this.html_ = module$contents$goog$html$SafeHtml_SafeHtml.htmlEscapePreservingNewlines(a);
    this.expanded_ = this.selected_ = !1;
    this.toolTip_ = null;
    this.afterLabelHtml_ = module$contents$goog$html$SafeHtml_SafeHtml.EMPTY;
            ...
            if (!a && c && this.contains(c.getSelectedItem()) && this.select(), d) {
                if (c = this.getChildrenElement())
                    if (goog.style.setElementShown(c, a), goog.a11y.aria.setState(d, goog.a11y.aria.State.EXPANDED, a), a && this.isInDocument() &&
                        !c.hasChildNodes()) {
                        var e = [];
                        this.forEachChild(function(f) {
                            e.push(f.toSafeHtml())
                        });
                        goog.dom.safe.setInnerHtml(c, module$contents$goog$html$SafeHtml_SafeHtml.concat(e));
                        this.forEachChild(function(f) {
                            f.enterDocument()
                        })
...
goog.ui.tree.BaseNode.prototype.toSafeHtml = function() {
    ...
    var c = [];
    a && this.forEachChild(function(d) {
        c.push(d.toSafeHtml())
    });
    a = module$contents$goog$html$SafeHtml_SafeHtml.create("div", b, c);
    return module$contents$goog$html$SafeHtml_SafeHtml.create("div", {
...
goog.ui.tree.BaseNode.prototype.getRowSafeHtml = function() {
    ...
    return module$contents$goog$html$SafeHtml_SafeHtml.create("div", a, b)
};
...
goog.ui.tree.BaseNode.prototype.getLabelSafeHtml = function() {
    var a = module$contents$goog$html$SafeHtml_SafeHtml.create("span", {
        "class": this.config_.cssItemLabel,
        title: this.getToolTip() || null
    }, this.getSafeHtml());
    return module$contents$goog$html$SafeHtml_SafeHtml.concat(a, module$contents$goog$html$SafeHtml_SafeHtml.create("span", {}, this.getAfterLabelSafeHtml()))
};
goog.ui.tree.BaseNode.prototype.getAfterLabelHtml = function() {
    return module$contents$goog$html$SafeHtml_SafeHtml.unwrap(this.getAfterLabelSafeHtml())
};
...
goog.ui.tree.BaseNode.prototype.getIconSafeHtml = function() {
    return module$contents$goog$html$SafeHtml_SafeHtml.create("span", {
        style: {
...
goog.ui.tree.BaseNode.prototype.getLineStyle = function() {
    ...
    return module$contents$goog$html$SafeStyle_SafeStyle.create({
...
goog.ui.tree.BaseNode.prototype.setText = function(a) {
    this.setSafeHtml(module$contents$goog$html$SafeHtml_SafeHtml.htmlEscape(a))
};
goog.ui.tree.BaseNode.prototype.getText = function() {
    return goog.string.unescapeEntities(module$contents$goog$html$SafeHtml_SafeHtml.unwrap(this.html_))
};
...
goog.ui.tree.BaseNode.prototype.getHtml = function() {
    return module$contents$goog$html$SafeHtml_SafeHtml.unwrap(this.getSafeHtml())
};
...
goog.ui.tree.BaseNode.prototype.onKeyDown = function(a) {
    ...
    b && (a.preventDefault(), (a = this.getTree()) && a.clearTypeAhead());
    return b
};
...
goog.structs.getCount = function(a) {
    return a.getCount && "function" == typeof a.getCount ? a.getCount() : goog.isArrayLike(a) || "string" === typeof a ? a.length : module$contents$goog$object_getCount(a)
};
...
goog.structs.contains = function(a, b) {
    return a.contains && "function" == typeof a.contains ? a.contains(b) : a.containsValue && "function" == typeof a.containsValue ? a.containsValue(b) : goog.isArrayLike(a) || "string" === typeof a ? module$contents$goog$array_contains(a, b) : module$contents$goog$object_containsValue(a, b)
};
goog.structs.isEmpty = function(a) {
    return a.isEmpty && "function" == typeof a.isEmpty ? a.isEmpty() : goog.isArrayLike(a) || "string" === typeof a ? 0 === a.length : module$contents$goog$object_isEmpty(a)
};
goog.structs.clear = function(a) {
    a.clear && "function" == typeof a.clear ? a.clear() : goog.isArrayLike(a) ? module$contents$goog$array_clear(a) : module$contents$goog$object_clear(a)
};
...
goog.structs.Trie.prototype.isEmpty = function() {
    return void 0 === this.value_ && module$contents$goog$object_isEmpty(this.childNodes_)
};
...
goog.ui.tree.TypeAhead.prototype.handleTypeAheadChar = function(a) {
    ...
    if (!a.ctrlKey && !a.altKey) {
        var c = "";
        a.charCode ? c = String.fromCharCode(a.charCode).toLowerCase() : goog.events.KeyCodes.isCharacterKey(a.keyCode) && (c = String.fromCharCode(a.keyCode).toLowerCase());
        c && goog.string.isUnicodeChar(c) && (" " != c || this.buffer_) && (this.buffer_ += c, b = this.jumpToLabel_(this.buffer_))
    }
    return b
};
...
goog.ui.tree.TypeAhead.prototype.removeNodeFromMap = function(a) {
    ...
    if (b && !goog.string.isEmptyOrWhitespace(goog.string.makeSafe(b))) {
        ...
        if (c) {
            ...
            module$contents$goog$array_remove(c, a);
...
goog.ui.tree.TreeControl.prototype.getExpandIconSafeHtml = function() {
    return module$contents$goog$html$SafeHtml_SafeHtml.EMPTY
};
...
goog.ui.tree.TreeControl.prototype.attachEvents_ = function() {
    ...
    this.getHandler().listen(c, goog.events.FocusHandler.EventType.FOCUSOUT, this.handleBlur_).listen(c, goog.events.FocusHandler.EventType.FOCUSIN, this.handleFocus_).listen(b, goog.events.KeyEvent.EventType.KEY, this.handleKeyEvent).listen(a, goog.events.EventType.MOUSEDOWN, this.handleMouseEvent_).listen(a,
...
goog.ui.tree.TreeControl.prototype.createNode = function(a) {
    return new goog.ui.tree.TreeNode(a || module$contents$goog$html$SafeHtml_SafeHtml.EMPTY, this.getConfig(), this.getDomHelper())
};
...
goog.ui.registry.getDefaultRenderer = function(a) {
    for (var b; a;) {
        ...
        a = module$contents$goog$object_getSuperClass(a)
    }
    return b ? "function" === typeof b.getInstance ? b.getInstance() : new b : null
};
goog.ui.registry.setDefaultRenderer = function(a, b) {
    if ("function" !== typeof a) throw Error("Invalid component class " + a);
...
goog.ui.ContainerRenderer.prototype.decorate = function(a, b) {
    ...
    e && Array.prototype.forEach.call(e, function(f) {
        f == c ? d = !0 : f && this.setStateFromClassName(a, f, c)
    }, this);
...
goog.ui.ControlRenderer.prototype.enableClassName = function(a, b, c) {
    (a = a.getElement ? a.getElement() : a) && goog.dom.classlist.enableAll(a, [b], c)
};
...
goog.ui.ControlRenderer.prototype.decorate = function(a, b) {
    ...
    c && c.firstChild ? a.setContentInternal(c.firstChild.nextSibling ? module$contents$goog$array_toArray(c.childNodes) : c.firstChild) : a.setContentInternal(null);
    var d = 0,
        e = this.getCssClass(),
        f = this.getStructuralCssClass(),
        g = !1,
        h = !1,
        k = module$contents$goog$array_toArray(goog.dom.classlist.get(b));
    k.forEach(function(m) {
        g || m != e ? h || m != f ? d |= this.getStateFromClass(m) : h = !0 : (g = !0, f == e && (h = !0));
        this.getStateFromClass(m) ==
    ...
    l && k.push.apply(k, l);
    g && h && !l || goog.dom.classlist.set(b, k.join(" "));
    return b
};
...
goog.ui.ControlRenderer.prototype.setAllowTextSelection = function(a, b) {
    goog.style.setUnselectable(a, !b, !goog.userAgent.IE)
};
        ...
        if ("string" === typeof b) goog.dom.setTextContent(c, b);
            ...
            var d = function(e) {
                if (e) {
                    ...
                    c.appendChild("string" === typeof e ? f.createTextNode(e) : e)
                }
            };
            Array.isArray(b) ? b.forEach(d) : !goog.isArrayLike(b) || "nodeType" in b ? d(b) : module$contents$goog$array_toArray(b).forEach(d)
        }
};
...
goog.ui.ControlRenderer.prototype.getAppliedCombinedClassNames_ = function(a, b) {
    var c = [];
    b && (a = module$contents$goog$array_concat(a, [b]));
    this.getIe6ClassCombinations().forEach(function(d) {
        !module$contents$goog$array_every(d, goog.partial(module$contents$goog$array_contains, a)) || b && !module$contents$goog$array_contains(d, b) || c.push(d.join("_"))
    });
    return c
};
...
goog.ui.ControlRenderer.prototype.createClassByStateMap_ = function() {
    ...
    this.classByState_ = module$contents$goog$object_create(goog.ui.Component.State.DISABLED, a + "-disabled", goog.ui.Component.State.HOVER, a + "-hover", goog.ui.Component.State.ACTIVE, a + "-active", goog.ui.Component.State.SELECTED, a + "-selected", goog.ui.Component.State.CHECKED,
        a + "-checked", goog.ui.Component.State.FOCUSED, a + "-focused", goog.ui.Component.State.OPENED, a + "-open")
};
goog.ui.ControlRenderer.prototype.createStateByClassMap_ = function() {
    this.classByState_ || this.createClassByStateMap_();
    this.stateByClass_ = module$contents$goog$object_transpose(this.classByState_)
};
...
goog.ui.Control.prototype.removeClassName = function(a) {
    a && this.extraClassNames_ && module$contents$goog$array_remove(this.extraClassNames_, a) && (0 == this.extraClassNames_.length && (this.extraClassNames_ = null), this.renderer_.enableExtraClassName(this, a, !1))
};
...
goog.ui.Control.prototype.enterDocument = function() {
    ...
    if (this.supportedStates_ & ~goog.ui.Component.State.DISABLED && (this.isHandleMouseEvents() && this.enableMouseEventHandling_(!0), this.isSupportedState(goog.ui.Component.State.FOCUSED))) {
        ...
        if (a) {
            ...
            b.attach(a);
            this.getHandler().listen(b, goog.events.KeyEvent.EventType.KEY,
...
goog.ui.Control.prototype.enableMouseEventHandling_ = function(a) {
    ...
    a ? (c.listen(d, b.MOUSEDOWN, this.handleMouseDown).listen(d, [b.MOUSEUP, b.MOUSECANCEL], this.handleMouseUp).listen(d, goog.events.EventType.MOUSEOVER, this.handleMouseOver).listen(d, goog.events.EventType.MOUSEOUT, this.handleMouseOut), this.pointerEventsEnabled() && c.listen(d, goog.events.EventType.GOTPOINTERCAPTURE, this.preventPointerCapture_), this.handleContextMenu !=
        ...
        goog.events.EventType.MOUSEOVER, this.handleMouseOver).unlisten(d, goog.events.EventType.MOUSEOUT, this.handleMouseOut), this.pointerEventsEnabled() && c.unlisten(d, goog.events.EventType.GOTPOINTERCAPTURE, this.preventPointerCapture_), this.handleContextMenu != goog.nullFunction && c.unlisten(d, goog.events.EventType.CONTEXTMENU, this.handleContextMenu), goog.userAgent.IE && (goog.userAgent.isVersionOrHigher(9) || c.unlisten(d, goog.events.EventType.DBLCLICK, this.handleDblClick), module$contents$goog$dispose_dispose(this.ieMouseEventSequenceSimulator_),
...
goog.ui.Control.prototype.getCaption = function() {
    ...
    if (!a) return "";
    a = "string" === typeof a ? a : Array.isArray(a) ? a.map(goog.dom.getRawTextContent).join("") : goog.dom.getTextContent(a);
...
goog.ui.Container.prototype.enterDocument = function() {
    ...
    this.forEachChild(function(c) {
        c.isInDocument() && this.registerChildId_(c)
    }, this);
    var a = this.getElement();
    this.renderer_.initializeDom(this);
...
goog.ui.Container.prototype.removeChild = function(a, b) {
    ...
    if (a) {
        ...
        (c = a.getElement()) && c.id && this.childElementIdMap_ && module$contents$goog$object_remove(this.childElementIdMap_, c.id)
    }
...
goog.ui.Container.prototype.setEnabled = function(a) {
    this.enabled_ != a && this.dispatchEvent(a ? goog.ui.Component.EventType.ENABLE : goog.ui.Component.EventType.DISABLE) && (a ? (this.enabled_ = !0, this.forEachChild(function(b) {
...
goog.ui.MenuItem.prototype.getCaption = function() {
    ...
    if (Array.isArray(a)) {
        ...
        a = module$contents$goog$array_map(a, function(d) {
            return goog.dom.isElement(d) && (goog.dom.classlist.contains(d, b) || goog.dom.classlist.contains(d, c)) ? "" : goog.dom.getRawTextContent(d)
        }).join("");
        return goog.string.collapseBreakingSpaces(a)
    }
...
goog.ui.MenuItem.prototype.getAccelerator = function() {
    var a = this.getDomHelper(),
        b = this.getContent();
    return Array.isArray(b) && (b = module$contents$goog$array_find(b, function(c) {
        return goog.dom.classlist.contains(c, goog.ui.MenuItem.ACCELERATOR_CLASS)
...
goog.ui.Menu.prototype.highlightNextPrefix = function(a) {
    ...
    return this.highlightHelper(function(c, d) {
        var e = 0 > c ? 0 : c,
            f = !1;
        do {
            ++c;
            c == d && (c = 0, f = !0);
            var g = this.getChildAt(c).getCaption();
...
goog.iter.ES6_ITERATOR_DONE = goog.debug.freeze({
    done: !0,
    value: void 0
});
goog.iter.createEs6IteratorYield = function(a) {
    return {
        value: a,
        done: !1
    }
};
goog.iter.toEs4IteratorNext = function(a) {
    if (a.done) throw goog.iter.StopIteration;
    return a.value
};
goog.iter.checkNoImplicitStopIterationInEs6 = function(a) {
    if (a === goog.iter.StopIteration) throw Error("ES6 Iteration protocol does NOT adjust control flow when StopIteration is thrown from callback helper functions. If your code relies on this behavior, consider throwing a different error and catching it to terminate iteration.");
    throw a;
};
...
goog.iter.forEach = function(a, b, c) {
    if (goog.isArrayLike(a)) try {
        ...
        try {
            for (;;) b.call(c, a.nextValueOrThrow(), void 0, a)
        } catch (d) {
            if (d !== goog.iter.StopIteration) throw d;
        }
    }
...
goog.iter.filter = function(a, b, c) {
    ...
    a.nextValueOrThrow = function() {
        for (;;) {
            var e = d.nextValueOrThrow();
...
goog.iter.some = function(a, b, c) {
    ...
    try {
        for (;;)
            if (b.call(c, a.nextValueOrThrow(), void 0, a)) return !0
    } catch (d) {
        if (d !== goog.iter.StopIteration) throw d;
    }
    return !1
...
goog.iter.every = function(a, b, c) {
    ...
    try {
        for (;;)
            if (!b.call(c, a.nextValueOrThrow(), void 0, a)) return !1
    } catch (d) {
        if (d !== goog.iter.StopIteration) throw d;
    }
    return !0
...
goog.iter.chainFromIterable = function(a) {
    ...
    a.nextValueOrThrow = function() {
        for (;;) {
            if (null == c) {
                var d = b.nextValueOrThrow();
                c = goog.iter.toIterator(d)
            }
            try {
                return c.nextValueOrThrow()
            } catch (e) {
...
goog.iter.toArray = function(a) {
    if (goog.isArrayLike(a)) return module$contents$goog$array_toArray(a);
    a = goog.iter.toIterator(a);
    var b = [];
...
goog.iter.nextOrValue = function(a, b) {
    try {
        return goog.iter.toIterator(a).nextValueOrThrow()
    } catch (c) {
...
goog.iter.product = function(a) {
    ...
    var b = new goog.iter.Iterator,
        c = arguments,
        d = module$contents$goog$array_repeat(0, c.length);
    b.nextValueOrThrow = function() {
        if (d) {
...
goog.iter.cycle = function(a) {
    ...
    a.nextValueOrThrow = function() {
        var f = null;
        if (!e) try {
            return f = b.nextValueOrThrow(), c.push(f), f
        } catch (g) {
            if (g != goog.iter.StopIteration || module$contents$goog$array_isEmpty(c)) throw g;
            e = !0
        }
        f = c[d];
        d = (d + 1) % c.length;
...
goog.iter.repeat = function(a) {
    var b = new goog.iter.Iterator;
    b.nextValueOrThrow = goog.functions.constant(a);
    return b
};
...
goog.iter.zipLongest = function(a, b) {
    ...
    if (0 < c.length) {
        ...
        d.nextValueOrThrow = function() {
            var f = !1,
                g = module$contents$goog$array_map(e, function(h) {
                    try {
                        var k = h.nextValueOrThrow();
                        f = !0
                    } catch (l) {
...
goog.iter.GroupByIterator_.prototype.nextValueOrThrow = function() {
    for (; this.currentKey == this.targetKey;) this.currentValue = this.iterator.nextValueOrThrow(), this.currentKey = this.keyFunc(this.currentValue);
...
goog.iter.starMap = function(a, b, c) {
    ...
    a = new goog.iter.Iterator;
    a.nextValueOrThrow = function() {
        var e = goog.iter.toArray(d.nextValueOrThrow());
...
goog.iter.tee = function(a, b) {
    var c = goog.iter.toIterator(a),
        d = module$contents$goog$array_map(module$contents$goog$array_range("number" === typeof b ? b : 2), function() {
            return []
        }),
        e = function() {
            var f = c.nextValueOrThrow();
...
goog.iter.limit = function(a, b) {
    ...
    var c = goog.iter.toIterator(a),
        ...
        e = b;
    d.nextValueOrThrow = function() {
        if (0 < e--) return c.nextValueOrThrow();
        throw goog.iter.StopIteration;
    };
    return d
};
...
goog.iter.permutations = function(a, b) {
    ...
    c = module$contents$goog$array_repeat(c, "number" === typeof b ? b : c.length);
    c = goog.iter.product.apply(void 0, c);
    return goog.iter.filter(c, function(d) {
        return !goog.iter.hasDuplicates_(d)
    })
};
goog.iter.combinations = function(a, b) {
    ...
    var f = goog.iter.filter(e, function(g) {
        return module$contents$goog$array_isSorted(g)
    });
    e = new goog.iter.Iterator;
    e.nextValueOrThrow = function() {
        return module$contents$goog$array_map(f.nextValueOrThrow(), c)
    };
    return e
};
goog.iter.combinationsWithReplacement = function(a, b) {
    ...
    var d = goog.iter.toArray(a),
        e = module$contents$goog$array_range(d.length);
    e = module$contents$goog$array_repeat(e, b);
...
goog.dom.NodeIterator.prototype.nextValueOrThrow = function() {
    do goog.dom.NodeIterator.superClass_.nextValueOrThrow.call(this); while (this.isEndTag());
    return this.node
};
...
goog.dom.dataset = {};
goog.dom.dataset.ALLOWED_ = !goog.userAgent.product.IE && !module$contents$goog$labs$userAgent$browser_matchSafari();
...
goog.dom.dataset.get = function(a, b) {
    ...
    if (goog.dom.dataset.ALLOWED_ && a.dataset) {
        if (module$contents$goog$labs$userAgent$browser_matchAndroidBrowser() && !(b in a.dataset)) return null;
        var c = a.dataset[b];
...
goog.ui.PaletteRenderer.prototype.createDom = function(a) {
    ...
    b = a.getDomHelper().createDom(goog.dom.TagName.DIV, b, this.createGrid(a.getContent(), a.getSize(), a.getDomHelper()));
...
goog.ui.PaletteRenderer.prototype.createTable = function(a, b) {
    ...
    goog.a11y.aria.setRole(c, goog.a11y.aria.Role.GRID);
    c.cellSpacing = "0";
    c.cellPadding = "0";
    return c
};
    ...
    if (a) {
        ...
        if (c) {
            ...
            Array.prototype.forEach.call(c.rows, function(k) {
                module$contents$goog$array_forEach(k.cells, function(l) {
                    goog.dom.removeChildren(l);
                    goog.a11y.aria.removeState(l, goog.a11y.aria.State.LABEL);
                    if (b) {
                        var m = b[d++];
                        m && (goog.dom.appendChild(l, m), this.maybeUpdateAriaLabel_(l))
                    }
                }, this)
            }, this);
            if (d < b.length) {
                for (var e = [], f = goog.dom.getDomHelper(a),
                        g = goog.dom.dataset.get(a, goog.ui.PaletteRenderer.GRID_WIDTH_ATTRIBUTE); d < b.length;) {
                    var h = b[d++];
...
goog.ui.SelectionModel.prototype.indexOfItem = function(a) {
    return a ? this.items_.indexOf(a) : -1
};
...
goog.ui.SelectionModel.prototype.addItems = function(a) {
    a && (a.forEach(function(b) {
        this.selectItem_(b, !1)
    }, this), module$contents$goog$array_extend(this.items_, a))
};
...
goog.ui.SelectionModel.prototype.addItemAt = function(a, b) {
    a && (this.selectItem_(a, !1), module$contents$goog$array_insertAt(this.items_, a, b))
};
goog.ui.SelectionModel.prototype.removeItem = function(a) {
    a && module$contents$goog$array_remove(this.items_, a) && a == this.selectedItem_ && (this.selectedItem_ = null, this.dispatchEvent(goog.events.EventType.SELECT))
};
...
goog.ui.SelectionModel.prototype.getItems = function() {
    return module$contents$goog$array_toArray(this.items_)
};
...
goog.ui.SelectionModel.prototype.clear = function() {
    module$contents$goog$array_clear(this.items_);
...
goog.ui.Palette.prototype.handleKeyEvent = function(a) {
    ...
    if (a.keyCode == goog.events.KeyCodes.HOME) return this.setHighlightedIndexInternal_(0, !0), !0;
    if (a.keyCode == goog.events.KeyCodes.END) return this.setHighlightedIndexInternal_(b - 1, !0), !0;
    var d = 0 > this.highlightedIndex_ ? this.getSelectedIndex() :
        this.highlightedIndex_;
    switch (a.keyCode) {
        case goog.events.KeyCodes.LEFT:
            if (-1 == d || 0 == d) d = b;
            this.setHighlightedIndexInternal_(d - 1, !0);
            a.preventDefault();
            return !0;
        case goog.events.KeyCodes.RIGHT:
            return d == b - 1 && (d = -1), this.setHighlightedIndexInternal_(d + 1, !0), a.preventDefault(), !0;
        case goog.events.KeyCodes.UP:
            -1 == d && (d = b + c - 1);
            if (d >= c) return this.setHighlightedIndexInternal_(d - c, !0), a.preventDefault(), !0;
            break;
        case goog.events.KeyCodes.DOWN:
            if (-1 == d && (d = -c), d < b - c) return this.setHighlightedIndexInternal_(d +
                c, !0), a.preventDefault(), !0
    }
    return !1
};
...
goog.ui.Palette.prototype.setHighlightedIndex = function(a) {
    this.setHighlightedIndexInternal_(a, !1)
};
goog.ui.Palette.prototype.setHighlightedIndexInternal_ = function(a, b) {
    if (a != this.highlightedIndex_) {
        ...
        if (b) {
            var c = goog.asserts.assert(this.getHighlightedCellElement_(), "Highlighted item must exist to scroll to make it visible in container. Please check that index is non-negative and valid.");
            goog.style.scrollIntoContainerView(c, this.getParent().getElementStrict())
        }
...
goog.ui.Palette.prototype.setHighlightedItem = function(a) {
    var b = this.getContent();
    this.setHighlightedIndex(b && a ? b.indexOf(a) : -1)
};
...
goog.ui.ColorPalette.prototype.setSelectedColor = function(a) {
    ...
    this.normalizedColors_ || (this.normalizedColors_ = this.colors_.map(function(b) {
        return goog.ui.ColorPalette.parseColor_(b)
    }));
    this.setSelectedIndex(a ? this.normalizedColors_.indexOf(a) : -1)
};
goog.ui.ColorPalette.prototype.createColorNodes = function() {
    return this.colors_.map(function(a, b) {
...
goog.cssom.getAllCssStyleSheets = function(a, b) {
    ...
    if (d.imports && d.imports.length)
        for (var f = 0, g = d.imports.length; f < g; f++) module$contents$goog$array_extend(c, goog.cssom.getAllCssStyleSheets(d.imports[f]));
    else if (d.length)
        for (f = 0, g = d.length; f < g; f++) module$contents$goog$array_extend(c, goog.cssom.getAllCssStyleSheets(d[f]));
    else {
        var h = goog.cssom.getCssRulesFromStyleSheet(d);
        if (h && h.length) {
            f = 0;
            g = h.length;
            for (var k; f < g; f++) k = h[f], k.styleSheet && module$contents$goog$array_extend(c,
                goog.cssom.getAllCssStyleSheets(k.styleSheet))
        }
...
goog.cssom.getCssTextFromCssRule = function(a) {
    ...
    try {
        ...
        return ""
    }!b && a.style && a.style.cssText && a.selectorText && (b = a.style.cssText.replace(/\s*-closure-parent-stylesheet:\s*\[object\];?\s*/gi, "").replace(/\s*-closure-rule-index:\s*[\d]+;?\s*/gi, ""), b = a.selectorText + " { " + b + " }");
    return b
};
...
goog.cssom.replaceCssRule = function(a, b, c, d) {
    if (c = c || goog.cssom.getParentStyleSheet(a))
        if (a = 0 <= Number(d) ? Number(d) : goog.cssom.getCssRuleIndexInParentStyleSheet(a, c), 0 <= a) goog.cssom.removeCssRule(c, a), goog.cssom.addCssRule(c, b, a);
...
goog.cssom.addCssText = function(a, b) {
    var c = b || goog.dom.getDomHelper(),
        d = c.getDocument(),
        e = c.createElement(goog.dom.TagName.STYLE),
        f = goog.dom.safe.getStyleNonce();
    f && e.setAttribute("nonce", f);
    e.type = "text/css";
    c.getElementsByTagName(goog.dom.TagName.HEAD)[0].appendChild(e);
    e.styleSheet ? e.styleSheet.cssText = a : (c = d.createTextNode(a), e.appendChild(c));
    return e
};
...
goog.debug.ErrorHandler.prototype.getProtectedFunction = function(a) {
    ...
    c[this.getFunctionIndex_(!1)] = a;
    return c
};
goog.debug.ErrorHandler.prototype.handleError_ = function(a) {
    var b = goog.debug.ErrorHandler.ProtectedFunctionError.MESSAGE_PREFIX;
    if (!(a && "object" === typeof a && "string" === typeof a.message && 0 == a.message.indexOf(b) || "string" === typeof a && 0 == a.indexOf(b))) {
        this.errorHandlerFn_(a);
        if (!this.wrapErrors_) throw this.prefixErrorMessages_ && ("object" === typeof a && a && "string" === typeof a.message ? a.message = b + a.message : a = b + a), goog.DEBUG && a && "string" === typeof a.stack && Error.captureStackTrace && goog.global.console && goog.global.console.error(a.message,
            a.stack), a;
        throw new goog.debug.ErrorHandler.ProtectedFunctionError(a);
    }
};
...
goog.debug.ErrorHandler.prototype.catchUnhandledRejections = function(a) {
    var b = this;
    a = a || goog.global.window;
    "onunhandledrejection" in a && (a.onunhandledrejection = function(c) {
        b.handleError_(c && c.reason ? c.reason : Error("uncaught error"))
    })
};
goog.debug.ErrorHandler.prototype.protectWindowRequestAnimationFrame = function() {
    for (var a = goog.global.window, b = ["requestAnimationFrame", "mozRequestAnimationFrame", "webkitAnimationFrame", "msRequestAnimationFrame"], c = 0; c < b.length; c++) {
        var d = b[c];
        b[c] in a && this.protectWindowFunctionsHelper_(d)
    }
};
goog.debug.ErrorHandler.prototype.protectWindowFunctionsHelper_ = function(a) {
    var b = goog.global.window,
        c = b[a],
        d = this;
    b[a] = function(e, f) {
        "string" === typeof e && (e = goog.partial(goog.globalEval, e));
        arguments[0] = e = d.protectEntryPoint(e);
...
goog.debug.ErrorHandler.ProtectedFunctionError = function(a) {
    module$contents$goog$debug$Error_DebugError.call(this, goog.debug.ErrorHandler.ProtectedFunctionError.MESSAGE_PREFIX + (a && a.message ? String(a.message) : String(a)), a);
    (a = a && a.stack) && "string" === typeof a && (this.stack = a)
};
goog.inherits(goog.debug.ErrorHandler.ProtectedFunctionError, module$contents$goog$debug$Error_DebugError);
...
Blockly.BlockSvg.prototype.renderCompute_ = function(a) {
    ...
    for (var d = 0, e = 0, f = !1, g = !1, h = !1, k = void 0, l = this.block_.inputsInline && !this.block_.isCollapsed(), m = 0, n; n = b[m]; m++)
        if (n.isVisible()) {
            if (l && k && k != Blockly.NEXT_STATEMENT && n.type != Blockly.NEXT_STATEMENT) var p = c[c.length - 1];
            else k = n.type, p = [], p.type = l && n.type != Blockly.NEXT_STATEMENT ? Blockly.BlockSvg.INLINE : n.type, p.height = 0, c.push(p);
            p.push(n);
            ...
            if (n.connection && n.connection.targetConnection) {
            ...
            m == b.length - 1 && n.renderHeight--;
            p.height =
                Math.max(p.height, n.renderHeight);
            n.fieldWidth = 0;
            1 == c.length && (n.fieldWidth += Blockly.RTL ? -a : a);
            q = !1;
            for (var r = 0, t; t = n.fieldRow[r]; r++) {
                0 != r && (n.fieldWidth += Blockly.BlockSvg.SEP_SPACE_X);
                var u = t.getSize();
                t.renderWidth = u.width;
                t.renderSep = q && t.EDITABLE ? Blockly.BlockSvg.SEP_SPACE_X : 0;
                n.fieldWidth += t.renderWidth + t.renderSep;
                p.height = Math.max(p.height, u.height);
                q = t.EDITABLE
            }
            p.type != Blockly.BlockSvg.INLINE && (p.type == Blockly.NEXT_STATEMENT ? (g = !0, e = Math.max(e, n.fieldWidth)) : (p.type == Blockly.INPUT_VALUE ?
                f = !0 : p.type == Blockly.DUMMY_INPUT && (h = !0), d = Math.max(d, n.fieldWidth)))
        } for (a = 0; p = c[a]; a++)
...
Blockly.BlockSvg.prototype.renderDrawRight_ = function(a, b, c, d, e, f, g) {
    for (var h, k = 0, l, m, n = 0, p; p = f[n]; n++) {
        ...
        if (this.block_.isCollapsed()) {
        ...
        } else p.type == Blockly.INPUT_VALUE ? (q = p[0], l = k + Blockly.BlockSvg.FIELD_HEIGHT, q.align != Blockly.ALIGN_LEFT && (r = f.rightEdge - q.fieldWidth - Blockly.BlockSvg.TAB_WIDTH - 2 * Blockly.BlockSvg.SEP_SPACE_X, q.align == Blockly.ALIGN_RIGHT ? h += r : q.align == Blockly.ALIGN_CENTRE && (h += (r + h) / 2)), this.renderFields_(q.fieldRow,
            h, l), a.push(Blockly.BlockSvg.TAB_PATH_DOWN), r = p.height - Blockly.BlockSvg.TAB_HEIGHT, a.push("v", r), Blockly.RTL ? (b.push(Blockly.BlockSvg.TAB_PATH_DOWN_HIGHLIGHT_RTL), b.push("v", r)) : (b.push("M", f.rightEdge - 4.2 + "," + (k + Blockly.BlockSvg.TAB_HEIGHT - .4)), b.push("l", .42 * Blockly.BlockSvg.TAB_WIDTH + ",-1.8")), l = e.x + (Blockly.RTL ? -f.rightEdge - 1 : f.rightEdge + 1), m = e.y + k, q.connection.moveTo(l, m), q.connection.targetConnection && (q.connection.tighten_(), this.width = Math.max(this.width, f.rightEdge + q.connection.targetBlock().getHeightWidth().width -
            Blockly.BlockSvg.TAB_WIDTH + 1))) : p.type == Blockly.DUMMY_INPUT ? (q = p[0], l = k + Blockly.BlockSvg.FIELD_HEIGHT, q.align != Blockly.ALIGN_LEFT && (r = f.rightEdge - q.fieldWidth - 2 * Blockly.BlockSvg.SEP_SPACE_X, f.hasValue && (r -= Blockly.BlockSvg.TAB_WIDTH), q.align == Blockly.ALIGN_RIGHT ? h += r : q.align == Blockly.ALIGN_CENTRE && (h += (r + h) / 2)), this.renderFields_(q.fieldRow, h, l), a.push("v", p.height), Blockly.RTL && b.push("v", p.height - 2)) : p.type == Blockly.NEXT_STATEMENT && (q = p[0], 0 == n && (a.push("v", Blockly.BlockSvg.SEP_SPACE_Y), Blockly.RTL &&
                b.push("v", Blockly.BlockSvg.SEP_SPACE_Y - 1), k += Blockly.BlockSvg.SEP_SPACE_Y), l = k + Blockly.BlockSvg.FIELD_HEIGHT, q.align != Blockly.ALIGN_LEFT && (r = f.statementEdge - q.fieldWidth - 2 * Blockly.BlockSvg.SEP_SPACE_X, q.align == Blockly.ALIGN_RIGHT ? h += r : q.align == Blockly.ALIGN_CENTRE && (h += (r + h) / 2)), this.renderFields_(q.fieldRow, h, l), h = f.statementEdge + Blockly.BlockSvg.NOTCH_WIDTH, a.push("H", h), a.push(Blockly.BlockSvg.INNER_TOP_LEFT_CORNER), a.push("v", p.height - 2 * Blockly.BlockSvg.CORNER_RADIUS), a.push(Blockly.BlockSvg.INNER_BOTTOM_LEFT_CORNER),
            a.push("H", f.rightEdge), Blockly.RTL ? (b.push("M", h - Blockly.BlockSvg.NOTCH_WIDTH + Blockly.BlockSvg.DISTANCE_45_OUTSIDE + "," + (k + Blockly.BlockSvg.DISTANCE_45_OUTSIDE)), b.push(Blockly.BlockSvg.INNER_TOP_LEFT_CORNER_HIGHLIGHT_RTL), b.push("v", p.height - 2 * Blockly.BlockSvg.CORNER_RADIUS), b.push(Blockly.BlockSvg.INNER_BOTTOM_LEFT_CORNER_HIGHLIGHT_RTL), b.push("H", f.rightEdge - 1)) : (b.push("M", h - Blockly.BlockSvg.NOTCH_WIDTH + Blockly.BlockSvg.DISTANCE_45_OUTSIDE + "," + (k + p.height - Blockly.BlockSvg.DISTANCE_45_OUTSIDE)),
                b.push(Blockly.BlockSvg.INNER_BOTTOM_LEFT_CORNER_HIGHLIGHT_LTR), b.push("H", f.rightEdge)), l = e.x + (Blockly.RTL ? -h : h), m = e.y + k + 1, q.connection.moveTo(l, m), q.connection.targetConnection && (q.connection.tighten_(), this.width = Math.max(this.width, f.statementEdge + q.connection.targetBlock().getHeightWidth().width)), n == f.length - 1 || f[n + 1].type == Blockly.NEXT_STATEMENT) && (a.push("v", Blockly.BlockSvg.SEP_SPACE_Y), Blockly.RTL && b.push("v", Blockly.BlockSvg.SEP_SPACE_Y - 1), k += Blockly.BlockSvg.SEP_SPACE_Y);
        k += p.height
    }
    f.length ||
...
Blockly.BlockSvg.prototype.renderDrawLeft_ = function(a, b, c, d) {
    this.block_.outputConnection ? (this.block_.outputConnection.moveTo(c.x, c.y), a.push("V", Blockly.BlockSvg.TAB_HEIGHT), a.push("c 0,-10 -" + Blockly.BlockSvg.TAB_WIDTH + ",8 -" + Blockly.BlockSvg.TAB_WIDTH + ",-7.5 s " + Blockly.BlockSvg.TAB_WIDTH + ",2.5 " + Blockly.BlockSvg.TAB_WIDTH + ",-7.5"), Blockly.RTL ? (b.push("M", -.3 * Blockly.BlockSvg.TAB_WIDTH + ",8.9"), b.push("l", -.45 * Blockly.BlockSvg.TAB_WIDTH + ",-2.1")) : (b.push("V", Blockly.BlockSvg.TAB_HEIGHT - 1), b.push("m",
        -.92 * Blockly.BlockSvg.TAB_WIDTH + ",-1 q " + -.19 * Blockly.BlockSvg.TAB_WIDTH + ",-5.5 0,-11"), b.push("m", .92 * Blockly.BlockSvg.TAB_WIDTH + ",1 V 1 H 2")), this.width += Blockly.BlockSvg.TAB_WIDTH) : Blockly.RTL || (this.squareTopLeftCorner_ ? b.push("V", 1) : b.push("V", Blockly.BlockSvg.CORNER_RADIUS));
    a.push("z")
};
...
Blockly.Scrollbar.prototype.onMouseDownBar_ = function(a) {
    ...
    if (!Blockly.isRightButton(a)) {
        ...
        var c = Blockly.getSvgXY_(this.svgKnob_);
...
Blockly.Xml.workspaceToDom = function(a) {
    if (Blockly.RTL) var b = a.getMetrics().viewWidth;
...
Blockly.Xml.blockToDom_ = function(a) {
    ...
    for (e = 0; c = a.inputList[e]; e++)
        if (f = !0, c.type != Blockly.DUMMY_INPUT) {
            g = c.connection.targetBlock();
            if (c.type == Blockly.INPUT_VALUE) {
                var h = goog.dom.createDom("value");
                d = !0
            } else c.type == Blockly.NEXT_STATEMENT && (h = goog.dom.createDom("statement"));
            g && (h.appendChild(Blockly.Xml.blockToDom_(g)), f = !1);
            h.setAttribute("name", c.name);
            f || b.appendChild(h)
        } d && b.setAttribute("inline", a.inputsInline);
    a.isCollapsed() && b.setAttribute("collapsed",
        !0);
...
Blockly.Xml.domToBlock = function(a, b, c) {
    ...
    var g = null;
    f = 0;
    for (var h; h = b.childNodes[f]; f++)
        if (3 != h.nodeType || !h.data.match(/^\s*$/)) {
            g = null;
            for (var k = 0, l; l = h.childNodes[k]; k++) 3 == l.nodeType && l.data.match(/^\s*$/) || (g = l);
...
Blockly.Xml.domToBlockObject = function(a, b, c) {
    var d = null,
        e = b.getAttribute("type");
    if (!e) throw "Block type unspecified: \n" + b.outerHTML;
    var f = b.getAttribute("id");
    if (c && f) {
        ...
        if (Blockly.Realtime.isEnabled()) return Blockly.Realtime.obtainBlock(a, e);
        d = new Blockly.Block;
        d.id = Blockly.genUid();
        d.fill(a, e)
    }(f = b.getAttribute("inline")) && d.setInputsInline("true" ==
        f);
    (f = b.getAttribute("disabled")) && d.setDisabled("true" == f);
        ...
        if (3 != h.nodeType || !h.data.match(/^\s*$/)) {
            ...
            switch (h.nodeName.toLowerCase()) {
                ...
                case "statement":
                    ...
                    if (!h) throw "Input " + k + " does not exist in block " + e;
                    if (g && "block" == g.nodeName.toLowerCase())
                        if (g = Blockly.Xml.domToBlockObject(a,
                                g, c), g.outputConnection) h.connection.connect(g.outputConnection);
                        else if (g.previousConnection) h.connection.connect(g.previousConnection);
                    else throw "Child block does not have output or previous statement.";
                    break;
                case "next":
                    if (g && "block" == g.nodeName.toLowerCase()) {
                        if (!d.nextConnection) throw "Next statement does not exist.";
                        if (d.nextConnection.targetConnection) throw "Next statement is already connected.";
                        g = Blockly.Xml.domToBlockObject(a, g, c);
                        if (!g.previousConnection) throw "Next block does not have previous statement.";
                        d.nextConnection.connect(g.previousConnection)
                    }
            }
...
Blockly.Bubble.prototype.renderArrow_ = function() {
    ...
    if (b == d && c == e) a.push("M " + b + "," + c);
        ...
        h = Math.min(h, m.width, m.height) / 2;
...
Blockly.Blocks.addTemplate = function(a) {
    ...
    var b = {
        init: function() {
            ...
            var d = [];
            d.push(a.text);
            a.args && a.args.forEach(function(e) {
                goog.asserts.assert(e.name);
                goog.asserts.assert("undefined" != e.check);
                "undefined" == e.type || e.type == Blockly.INPUT_VALUE ? d.push([e.name, e.check, "undefined" == typeof e.align ? Blockly.ALIGN_RIGHT : e.align]) : goog.asserts.fail("addTemplate() can only handle value inputs.")
            });
    ...
    b.mutationToDom = a.switchable ? function() {
        var c = a.mutationToDomFunc ?
            a.mutatationToDomFunc() : document.createElement("mutation");
        c.setAttribute("is_statement", this.isStatement || !1);
        return c
    } : a.mutationToDomFunc;
    Blockly.Blocks[a.blockName] = b
};
Blockly.Blocks.requireInFunction = function(a) {
    a ? a.workspace && (a.getSurroundParent() ? a.setWarningText(null) : a.setWarningText(Blockly.Msg.PLZ_INSIDE_FUNCTION)) : this.workspace && (this.getSurroundParent() ? this.setWarningText(null) : this.setWarningText(Blockly.Msg.PLZ_INSIDE_FUNCTION))
};
Blockly.Blocks.variablePlaceCheck = function(a) {
    a ? a.workspace && (!a.getSurroundParent() || "main_block" != a.getSurroundParent().type && "procedures_defnoreturn" != a.getSurroundParent().type && "procedures_defreturn" != a.getSurroundParent().type ? a.getSurroundParent() ? a.setWarningText(Blockly.Msg.PLZ_OUT_OF_BLOCK) : a.setWarningText(Blockly.Msg.PLZ_INSIDE_FUNCTION) : a.setWarningText(null)) : this.workspace && (!this.getSurroundParent() || "main_block" != this.getSurroundParent().type && "procedures_defnoreturn" != this.getSurroundParent().type &&
        "procedures_defreturn" != this.getSurroundParent().type ? this.getSurroundParent() ? this.setWarningText(Blockly.Msg.PLZ_OUT_OF_BLOCK) : this.setWarningText(Blockly.Msg.PLZ_INSIDE_FUNCTION) : this.setWarningText(null))
};
Blockly.Blocks.requireOutFunction = function(a) {
    a ? a.workspace && (!a.getSurroundParent() || "main_block" != a.getSurroundParent().type && "procedures_defnoreturn" != a.getSurroundParent().type && "procedures_defreturn" != a.getSurroundParent().type ? a.setWarningText(null) : a.setWarningText(Blockly.Msg.PLZ_OUT_OF_FUNCTION)) : this.workspace && (!this.getSurroundParent() || "main_block" != this.getSurroundParent().type && "procedures_defnoreturn" != this.getSurroundParent().type && "procedures_defreturn" != this.getSurroundParent().type ?
        this.setWarningText(null) : this.setWarningText(Blockly.Msg.PLZ_OUT_OF_FUNCTION))
};
Blockly.Blocks.checkArrayIndex = function(a, b) {
    return 1 == isNaN(a) ? !0 : 0 > a || 0 > b || a >= b ? !1 : !0
};
...
Blockly.Blocks.getIndexArray = function(a, b) {
    for (var c = [], d, e, f, g = 0; g < a.length; g++)
        if (a[g][2] == b) switch (d = a[g][5][1], e = a[g][5][2], f = a[g][5][3], a[g][5][0]) {
            case 1:
                f = e = -1;
                break;
            case 2:
...
Blockly.Blocks.arrayTestFunction = function(a, b, c, d) {
    0 != b && 0 == c && 0 == d ? a.setWarningText(null) : 0 != b && 0 != c && 0 == d ? a.setWarningText(null) : 0 != b && 0 != c && 0 != d ? a.setWarningText(null) : a.setWarningText("Warning: Array length must be writen by order.")
};
Blockly.Blocks.search = function(a) {
    a = Blockly.Blocks.searchTag(a);
    Blockly.Blocks.showResult(a)
};
Blockly.Blocks.searchTag = function(a) {
    for (var b = Blockly.Toolbox.tree_, c = [], d = 0; d < b.children_.length; d++) {
        var e = b.children_[d];
        if ("PROCEDURE" == e.blocks) e = new Blockly.Block, e.id = Blockly.genUid(), e.fill(Blockly.mainWorkspace, "procedures_defnoreturn"), c.push(e), e = new Blockly.Block, e.id = Blockly.genUid(), e.fill(Blockly.mainWorkspace, "procedures_defreturn"), c.push(e);
        else if ("STRUCTURE" == e.blocks) e = new Blockly.Block, e.id = Blockly.genUid(), e.fill(Blockly.mainWorkspace, "structure_define"), c.push(e), e = new Blockly.Block,
            e.id = Blockly.genUid(), e.fill(Blockly.mainWorkspace, "structure_declare"), c.push(e);
        else if (e.blocks.length)
            for (var f = 0; f < e.blocks.length; f++) {
                var g = Blockly.Xml.domToBlockObject(Blockly.mainWorkspace, e.blocks[f]);
                c.push(g)
            } else if ("result" != e.html_.privateDoNotAccessOrElseSafeHtmlWrappedValue_ && e.children_.length)
                for (f = 0; f < e.children_.length; f++) {
                    var h = e.children_[f];
                    if (h.blocks)
                        for (var k = 0; k < h.blocks.length; k++) g = Blockly.Xml.domToBlockObject(Blockly.mainWorkspace, h.blocks[k]), c.push(g)
                }
    }
    b = [];
    for (d =
        0; d < c.length; d++)
        if (c[d].tag)
            for (e = 0; e < c[d].tag.length; e++)
                if (-1 != c[d].tag[e].indexOf(a)) {
                    b.push(c[d]);
                    break
                } return b
};
Blockly.Blocks.checkResult = function(a, b) {
    for (var c = -1, d = 0; d < b.length; d++) b[d].type.toUpperCase() == a && (c = d);
    return c
};
Blockly.Blocks.showResult = function(a) {
    function b(f, g) {
        for (var h = 0, k; k = f.childNodes[h]; h++)
            if (k.tagName) {
                var l = k.tagName.toUpperCase();
                if ("CATEGORY" == l) {
                    l = d.createNode(k.getAttribute("name"));
                    l.blocks = [];
                    g.add(l);
                    var m = k.getAttribute("custom");
                    if (m)
                        for (l.blocks = m, l = 0; m = k.childNodes[l]; l++) {
                            if (m.tagName && "BLOCK" == m.tagName.toUpperCase()) {
                                var n = Blockly.Blocks.checkResult(m.getAttribute("type").toUpperCase(), a); - 1 != n && (a.splice(n, 1), e.blocks.push(m))
                            }
                        } else b(k, l)
                } else "BLOCK" == l && (g.blocks.push(k), n = Blockly.Blocks.checkResult(k.getAttribute("type").toUpperCase(),
                    a), -1 != n && (a.splice(n, 1), e.blocks.push(k)))
            }
    }
    var c = new Blockly.Toolbox.TreeControl(module$contents$goog$html$SafeHtml_SafeHtml.EMPTY, Blockly.Toolbox.CONFIG_);
    Blockly.Toolbox.tree_ = c;
    c.setShowRootNode(!1);
    c.setShowLines(!1);
    c.setShowExpandIcons(!1);
    var d = Blockly.Toolbox.tree_;
    d.removeChildren();
    d.blocks = [];
    var e = d.createNode("result");
    e.blocks = [];
    Blockly.Toolbox.tree_.add(e);
    b(Blockly.languageTree, Blockly.Toolbox.tree_);
    if (d.blocks.length) throw "Toolbox cannot have both blocks and categories in the root level.";
    Blockly.fireUiEvent(window, "resize");
    Blockly.Toolbox.HtmlDiv.childNodes[0].remove();
    c.setSelectedItem(e);
    c.render(Blockly.Toolbox.HtmlDiv)
};
Blockly.Blocks.checkLegalName = function(a, b) {
    var c = 0;
    if (0 < b.length) {
        var d = b.substring(0, 1);
        d.match(/[a-z]|[A-Z]/) || (c += 1)
    }
    for (var e = 1; e < b.length; e++) d = b.substring(e, e + 1), d.match(/[0-9]|[a-z]|[A-Z]|_/) || (c += 1);
    if (0 < c) return window.alert(a), -1
};
Blockly.Blocks.setCheckVariable = function(a, b, c) {
    switch (b) {
        case "int":
            a.getInput(c).setCheck("Number Aster Array Boolean Macro Variable VAR_INT NEGATIVE INT".split(" "));
            break;
        case "unsigned int":
            a.getInput(c).setCheck("Number Aster Array Boolean Macro Variable VAR_UNINT NEGATIVE".split(" "));
            break;
        case "float":
            a.getInput(c).setCheck("Number Aster Array Boolean Macro Variable VAR_FLOAT DOUBLE".split(" "));
        case "double":
            a.getInput(c).setCheck("Number Aster Array Boolean Macro Variable VAR_DOUBLE DOUBLE".split(" "));
            break;
        case "char":
            a.getInput(c).setCheck("String Aster Array Boolean Macro Variable VAR_CHAR CHAR Number INT".split(" "))
    }
};
Blockly.Blocks.setCheckPointer = function(a, b, c) {
    switch (b) {
        case "int":
            a.getInput(c).setCheck(["PTR_INT", "Address", "Pointer", "Array", "Aster"]);
            break;
        case "unsigned int":
            a.getInput(c).setCheck(["PTR_UNINT", "Address", "Pointer", "Array", "Aster"]);
            break;
        case "float":
            a.getInput(c).setCheck(["PTR_FLOAT", "Address", "Pointer", "Array", "Aster"]);
            break;
        case "double":
            a.getInput(c).setCheck(["PTR_DOUBLE", "Address", "Pointer", "Array", "Aster"]);
            break;
        case "char":
            a.getInput(c).setCheck("PTR_CHAR Address Pointer String STR CHAR Array Aster".split(" "));
            break;
        case "dbint":
            a.getInput(c).setCheck("DBPTR_INT Address Pointer Aster Array Aster".split(" "));
            break;
        case "dbunsigned int":
            a.getInput(c).setCheck("DBPTR_UNINT Address Pointer Aster Array Aster".split(" "));
            break;
        case "dbfloat":
            a.getInput(c).setCheck("DBPTR_FLOAT Address Pointer Aster Array Aster".split(" "));
            break;
        case "dbdouble":
            a.getInput(c).setCheck("DBPTR_DOUBLE Address Pointer Aster Array Aster".split(" "));
            break;
        case "dbchar":
            a.getInput(c).setCheck("DBPTR_CHAR Address Pointer String STR CHAR Array Aster".split(" "))
    }
};
Blockly.Blocks.checkUnselect = function(a) {
    if ("___EC_84_A0_ED_83_9D__" == a || "--Select--" == a || "___ED_83_80_EC_9E_85__" == a || "--Type--" == a) a = "unselected";
    return a
};
...
Blockly.Connection.prototype.connect = function(a) {
    ...
    if (this.isSuperior()) {
        c = this.sourceBlock_;
        var d = a.sourceBlock_
    } else c = a.sourceBlock_, d = this.sourceBlock_;
...
Blockly.Connection.prototype.disconnect = function() {
    ...
    if (this.isSuperior()) {
        ...
        a = a.sourceBlock_
    } else b = a.sourceBlock_, a = this.sourceBlock_;
    b.rendered && b.render();
...
Blockly.Connection.prototype.highlight = function() {
    if (this.type == Blockly.INPUT_VALUE || this.type == Blockly.OUTPUT_VALUE) {
        var a = Blockly.RTL ? -Blockly.BlockSvg.TAB_WIDTH : Blockly.BlockSvg.TAB_WIDTH;
        a = "m 0,0 v 5 c 0,10 " + -a + ",-8 " + -a + ",7.5 s " + a + ",-2.5 " + a + ",7.5 v 5"
    } else a = Blockly.RTL ? "m 20,0 h -5 l -6,4 -3,0 -6,-4 h -5" : "m -20,0 h 5 l 6,4 3,0 6,-4 h 5";
...
Blockly.Connection.prototype.closest = function(a, b, c) {
    function d(n) {
        var p = e[n];
        if ((p.type == Blockly.OUTPUT_VALUE || p.type == Blockly.PREVIOUS_STATEMENT) && p.targetConnection || p.type == Blockly.INPUT_VALUE && p.targetConnection && !p.targetBlock().isMovable() || !m.checkType_(p)) return !0;
        p = p.sourceBlock_;
        do {
            if (l == p) return !0;
            p = p.getParent()
...
Blockly.Connection.prototype.neighbours_ = function(a) {
    function b(l) {
        var m = d - c[l].x_,
            n = e - c[l].y_;
        Math.sqrt(m * m + n * n) <= a && k.push(c[l]);
        return n < a
    }
...
Blockly.ContextMenu.show = function(a, b) {
    ...
    if (b.length) {
        for (var c = new goog.ui.Menu, d = 0, e; e = b[d]; d++) {
            ...
            e.enabled && goog.events.listen(f, goog.ui.Component.EventType.ACTION, function(l) {
                return function() {
                    Blockly.doCommand(l)
                }
            }(e.callback))
...
Blockly.Tooltip.show_ = function() {
    ...
    if (Blockly.Tooltip.svgGroup_) {
        ...
        if (Blockly.RTL) {
            c = a.width;
            d = 0;
            for (var e; e = Blockly.Tooltip.svgText_.childNodes[d]; d++) e.setAttribute("text-anchor", "end"), e.setAttribute("x", c + Blockly.Tooltip.MARGINS)
        }
        c =
            Blockly.Tooltip.lastXY_.x;
...
Blockly.Mutator.prototype.resizeBubble_ = function() {
    ...
    var d = Blockly.RTL ? -b.x : b.width + b.x;
...
Blockly.Block.prototype.onMouseUp_ = function(a) {
    ...
    Blockly.doCommand(function() {
        ...
        if (Blockly.selected && Blockly.highlightedConnection_) Blockly.localConnection_.connect(Blockly.highlightedConnection_), b.svg_ && (Blockly.localConnection_.isSuperior() ? Blockly.highlightedConnection_ : Blockly.localConnection_).sourceBlock_.svg_.connectionUiEffect(), b.workspace.trashcan && b.workspace.trashcan.isOpen && b.workspace.trashcan.close();
            ...
            goog.Timer.callOnce(c.close, 100, c);
...
Blockly.Block.prototype.duplicate_ = function() {
    ...
    a = Blockly.Xml.domToBlock(this.workspace, a);
    var b = this.getRelativeToSurfaceXY();
        ...
        if (!("mousemove" == a.type && 1 >= a.clientX && 0 == a.clientY && 0 == a.button)) {
            ...
            if (2 == Blockly.Block.dragMode_) {
                ...
                for (e = 0; e < f.length; e++) {
                    var l = f[e],
                        m = l.closest(k, c, d);
                    m.connection && (g = m.connection, h = l, k = m.radius)
                }
...
Blockly.Block.prototype.setParent = function(a) {
    ...
    } else module$contents$goog$array_contains(this.workspace.getTopBlocks(!1), this) && this.workspace.removeTopBlock(this);
...
Blockly.Block.prototype.interpolateMsg = function(a, b) {
    function c(n) {
        n instanceof Blockly.Field ? this.appendField(n) : (goog.asserts.assert(goog.isArray(n)), this.appendField(n[1], n[0]))
    }
    ...
    for (var e = a.split(this.interpolateMsg.SPLIT_REGEX_), f = [], g = 0; g < e.length; g += 2) {
        ...
        if ((h = e[g + 1]) && "%" == h.charAt(0)) {
            var l = parseInt(h.substring(1), 10),
                m = arguments[l];
            goog.asserts.assertArray(m, 'Message symbol "%s" is out of range.', h);
            goog.asserts.assertArray(m, 'Argument "%s" is not a tuple.', h);
            m[1] instanceof Blockly.Field ? f.push([m[0], m[1]]) : k = this.appendValueInput(m[0]).setCheck(m[1]).setAlign(m[2]);
            arguments[l] = null
...
Blockly.Block.prototype.setWarningText = function(a) {
    ...
    var b = !1;
    goog.isString(a) ? (this.warning || (this.warning = new Blockly.Warning(this), b = !0), this.warning.setText(a), this.warning.setVisible(!0)) : this.warning && (this.warning.dispose(), b = !0);
...
Blockly.Blocks.CNameValidator = function(a) {
    return !RegExp("^[a-zA-Z_][a-zA-Z0-9_]*$").test(a) || RegExp("^index[0-9]+$").test(a) || -1 !== Blockly.cake.RESERVED_WORDS_.indexOf("," + a + ",") ? null : a
};
Blockly.Blocks.CreateMainBlock = function() {
    ...
    this.workspace_ = new Blockly.Workspace(function() {
        ...
        return a.setMetrics_(c)
    });
    var b = Blockly.Block.obtain(this.workspace_, "main_block");
    b = Blockly.Xml.blockToDom_(b);
    Blockly.Xml.domToBlock(Blockly.mainWorkspace, b).moveBy(20, 100);
    b.setAttribute("deletable", !1);
    b.setAttribute("movable", !1);
    b.setAttribute("editable", !1)
};
...
Blockly.FieldAngle = function(a, b) {
    if (b) {
        var c = this;
        var d = function(e) {
            e = Blockly.FieldAngle.angleValidator.call(c, e);
            null !== e && b.call(c, e);
            return e
        }
    } else d = Blockly.FieldAngle.angleValidator;
    this.symbol_ = Blockly.createSvgElement("tspan", {}, null);
    this.symbol_.appendChild(document.createTextNode("\u00b0"));
    Blockly.FieldAngle.superClass_.constructor.call(this, a, d)
};
...
Blockly.FieldColour.prototype.showEditor_ = function() {
    ...
    var g = this;
    Blockly.FieldColour.changeEventKey_ = goog.events.listen(a, goog.ui.ColorPicker.EventType.CHANGE, function(h) {
        h = h.target.getSelectedColor() || "#000000";
        Blockly.WidgetDiv.hide();
        if (g.changeHandler_) {
            var k = g.changeHandler_(h);
            void 0 !== k && (h = k)
        }
        null !== h && g.setValue(h)
    })
...
Blockly.FieldDropdown = function(a, b, c) {
    ...
    this.changeHandler_ = b;
    this.trimOptions_();
    a = this.getOptions_(c)[0];
    this.value_ = a[1];
    this.block = c;
    c = goog.userAgent.ANDROID ? "\u25bc" : "\u25be";
    this.arrow_ = Blockly.createSvgElement("tspan", {}, null);
    this.arrow_.appendChild(document.createTextNode(Blockly.RTL ? c + " " : " " + c));
...
Blockly.FieldDropdown.prototype.showEditor_ = function() {
    ...
    for (var a = this, b = new goog.ui.Menu, c = this.getOptions_(this.block), d = 0; d < c.length; d++) {
        var e = c[d][1],
    ...
    goog.events.listen(b, goog.ui.Component.EventType.ACTION, function(k) {
        if (k = k.target) {
            k = k.getValue();
            if (a.changeHandler_) {
                var l = a.changeHandler_(k);
                void 0 !== l && (k = l)
            }
            null !== k && a.setValue(k)
        }
...
Blockly.FieldDropdown.prototype.getOptions_ = function(a) {
    return goog.isFunction(this.menuGenerator_) ? this.menuGenerator_.call(this, a) : this.menuGenerator_
};
...
Blockly.FieldDropdown.prototype.getTypefromVars = function(a, b) {
    for (var c, d = Blockly.Variables.allVariables(), e = 0; e < d.length; e++) d[e][2] == a && (c = d[e][b]);
    return c
};
Blockly.FieldDropdown.prototype.getParentType = function(a, b) {
    var c = null;
    if (a.getParent()) {
        var d = a.getParent();
        if ("controls_for" == a.type) return null;
        d.type.match("procedures_callreturn") && (d = d.getParent());
        if (d.type == b + "_*" && "variables_set" == d.getParent().type || d.type == b + "_pointer_&" && d.getParent().type == b + "_pointer_set") c = d.getParent().getVars(), c = this.getTypefromVars(c, 0);
        else if (d.type != b + "_pointer_&" && d.type != b + "_pointer_*" || !d.getParent())
            if (d.type != b + "_&" && d.type != b + "_*" || d.getParent().type !=
                b + "_declare")
                if (d.type != b + "_&" && d.type != b + "_*" || d.getParent().type != b + "_set")("library_stdlib_malloc" == a.type || a.type == b + "_get") && 0 < d.type.search("_set") ? (d = d.getVars(), "variables_pointer" == b && (d = d.toString().replace("* ", "")), c = this.getTypefromVars(d, 0)) : a.type != b + "_set" && d.type.match("_declare") ? d.getDeclare() && (c = d.getTypes()) : d.type.match("main_block") ? c = "int" : d.type.match("procedures_return") && (c = d.getType());
                else {
                    c = d.getParent().getVars();
                    var e = this.getTypefromVars(c, 5);
                    c = this.getTypefromVars(c,
                        0);
                    "**" == e && d.type == b + "_&" ? c = c.replace("db", "") : "*" == e && d.type == b + "_*" && (c = "db" + c)
                }
        else e = d.getParent().getSpec(), "**" == e && d.type == b + "_&" ? c = d.getParent().getType() : "*" == e && d.type == b + "_*" && (c = d.getParent().getType(), c = "db" + c);
        else d.getParent().getVars() && (c = d.getParent().getTypes())
    }
    return c
};
Blockly.FieldDropdown.prototype.listCreate = function(a, b) {
    var c = Blockly.Variables.allVariables(),
        d = [],
        e = a.getRelativeToSurfaceXY().y;
    switch (b) {
        case 0:
            var f = "d";
            var g = "define";
        ...
        case 2:
            ...
            break;
        case 3:
            f = "a", g = "variables_array"
    }
    for (g = Blockly.FieldDropdown.prototype.getParentType(a, g); a.getSurroundParent() && "main_block" != a.getSurroundParent().type && "procedures_defnoreturn" != a.getSurroundParent().type && "procedures_defreturn" != a.getSurroundParent().type;) a =
        a.getSurroundParent();
    var h;
    a.getSurroundParent() && (h = a.getSurroundParent().getName());
    for (var k = 0; k < c.length; k++) c[k][1] == f && (c[k][3] == h || "Global" == c[k][3]) && c[k][4] < e - 10 && (null != g ? c[k][0] == g && d.push(c[k][2]) : d.push(c[k][2]));
    return d
};
...
Blockly.Flyout.prototype.hide = function() {
    if (this.isVisible()) {
        ...
        a = 0;
        for (var c; c = b[a]; a++) c.workspace == this.workspace_ && c.dispose(!1, !1);
...
Blockly.Flyout.prototype.show = function(a) {
    ...
    else if (a == Blockly.Structure.NAME_TYPE) Blockly.Structure.flyoutCategory(c, d, b, this.workspace_);
    else
        for (var e = 0, f; f = a[e]; e++) f.tagName && "BLOCK" == f.tagName.toUpperCase() && (f = Blockly.Xml.domToBlock(this.workspace_,
            f), c.push(f), d.push(3 * b));
    a = b;
    for (e = 0; f = c[e]; e++) {
        for (var g = f.getDescendants(), h = 0, k; k = g[h]; h++) k.isInFlyout = !0, k.setCommentText(null);
        f.render();
        g = f.getSvgRoot();
        h = f.getHeightWidth();
        ...
        f.flyoutRect_ = h;
        this.buttons_[e] = h;
        this.autoClose ? this.listeners_.push(Blockly.bindEvent_(g, "mousedown", null, this.createBlockFunc_(f))) :
            this.listeners_.push(Blockly.bindEvent_(g, "mousedown", null, this.blockMouseDown_(f)));
    ...
    this.listeners_.push(Blockly.bindEvent_(this.svgBackground_,
        "mouseover", this,
        function(l) {
            l = this.workspace_.getTopBlocks(!1);
            for (var m = 0, n; n = l[m]; m++) n.svg_.removeSelect()
        }));
    this.width_ = 0;
    this.reflow();
...
Blockly.Toolbox.createDom = function(a, b) {
    ...
    Blockly.bindEvent_(Blockly.Toolbox.HtmlDiv, "mousedown", null, function(c) {
        Blockly.isRightButton(c) || c.target == Blockly.Toolbox.HtmlDiv ? Blockly.hideChaff(!1) : Blockly.hideChaff(!0)
    })
};
Blockly.Toolbox.init = function() {
    ...
    var a = new Blockly.Toolbox.TreeControl(module$contents$goog$html$SafeHtml_SafeHtml.EMPTY, Blockly.Toolbox.CONFIG_);
...
Blockly.Toolbox.TreeControl.prototype.createNode = function(a) {
    return new Blockly.Toolbox.TreeNode(a ? module$contents$goog$html$SafeHtml_SafeHtml.htmlEscape(a) : module$contents$goog$html$SafeHtml_SafeHtml.EMPTY, this.getConfig(), this.getDomHelper())
};
...
Blockly.Variables.allVariables = function(a) {
    var b = a ? a.getDescendants() : Blockly.mainWorkspace.getAllBlocks();
    a = Object.create(null);
    for (var c = 0; c < b.length; c++) {
        var d = b[c].getDeclare,
            e = b[c].getParamInfo;
        if (d) {
            e = d.call(b[c]);
            var f = b[c].getTypes.call(b[c]),
                g = b[c].getDist.call(b[c]),
                h = b[c].getScope.call(b[c]),
                k = b[c].getPos.call(b[c]);
            d = b[c].getSpec.call(b[c]);
            for (var l = 0; l < g.length; l++) var m = g[l];
            for (g = 0; g < f.length; g++) var n = f[g];
            for (f = 0; f < e.length; f++) var p = e[f];
            if (h)
                for (f = 0; f < h.length; f++) var q = h[f];
            e =
                k;
            if ("v" != m && "d" != m) var r = d;
            p && q && (a[p.toLowerCase() + "." + q.toLowerCase()] = [n, m, p, q, e, r])
        } else if (e && (d = e.call(b[c])))
            for (e = 0; e < d.length; e++) a[d[e][2].toLowerCase() + "." + d[e][3].toLowerCase()] = [d[e][0], d[e][1], d[e][2], d[e][3], d[e][4], d[e][5]]
    }
    m = [];
    for (var t in a) m.push([a[t][0], a[t][1], a[t][2], a[t][3], a[t][4], a[t][5]]);
    return m
};
...
Blockly.Variables.flyoutCategory = function(a, b, c, d) {
    ...
    for (var f = void 0, g = 0; g < e.length; g++)
        if (e[g][1] !== f) {
            ...
            k && k.initSvg();
            null === e[g][1] ? f = (h || k).getVars()[0] : (h && h.setFieldValue(e[g][1], "VAR"), k && k.setFieldValue(e[g][1],
                "VAR"));
            k && a.push(k);
            h && a.push(h);
...
Blockly.Variables.generateUniqueName = function() {
    ...
    if (a.length) {
        ...
        for (var c = 0, d = "i", e, f; !b;) {
            e = 0;
            for (f = !1; e < a.length && !f;) a[e][1].toLowerCase() == d && (f = !0), e++;
...
Blockly.FieldVariable = function(a, b, c) {
    Blockly.FieldVariable.superClass_.constructor.call(this, Blockly.FieldVariable.dropdownCreate, b, c);
...
Blockly.FieldVariable.dropdownCreate = function(a) {
    a = Blockly.FieldDropdown.prototype.listCreate(a, 1);
    var b = this.getText();
    b && -1 == a.indexOf(b) ? a.push(b) : a.push(Blockly.Msg.SELECT_MENU);
    a.sort(goog.string.caseInsensitiveCompare);
    b = [];
...
Blockly.Structure.allStructure = function() {
    for (var a = Blockly.mainWorkspace.getAllBlocks(), b = [], c = [], d = 0; d < a.length; d++) {
        var e = a[d].getStructDefine;
        e && (e = e.call(a[d])) && b.push(e)
    }
    b.sort(Blockly.Structure.procTupleComparator_);
    for (d = 0; d < a.length; d++)
        if (e = a[d].getStructDeclare) {
            e = e.call(a[d]);
            var f = a[d].getTypes();
            f = f.toString();
            e = e.toString();
            for (var g, h, k, l, m = 0; m < b.length; m++) b[m][1] == f && (h = b[m][2], g = b[m][3], k = b[m][4], l = b[m][5]);
            e = ["sn", f, e, h, g, k, l];
            c.push(e)
        } c.sort(Blockly.Structure.procTupleComparator_);
    return [b, c]
};
Blockly.Structure.procTupleComparator_ = function(a, b) {
    var c = a[0].toLowerCase(),
        d = b[0].toLowerCase();
    return c > d ? 1 : c < d ? -1 : 0
};
Blockly.Structure.findLegalName = function(a, b) {
    if (b.isInFlyout) return a;
    for (; !Blockly.Structure.isLegalName(a, b.workspace, b);) {
        var c = a.match(/^(.*?)(\d+)$/);
        a = c ? c[1] + (parseInt(c[2], 10) + 1) : a + "2"
    }
    return a
};
Blockly.Structure.isLegalName = function(a, b, c) {
    b = b.getAllBlocks();
...
Blockly.Structure.rename = function(a) {
    a = a.replace(/^[\s\xa0]+|[\s\xa0]+$/g, "");
    a = Blockly.Structure.findLegalName(a, this.sourceBlock_);
...
Blockly.Structure.flyoutCategory = function(a, b, c, d) {
    if (Blockly.Blocks.structure_define) {
        var e = Blockly.Block.obtain(d, "structure_define");
        e.initSvg();
        a.push(e);
        b.push(2 * c)
    }
    Blockly.Blocks.structure_declare && (e = Blockly.Block.obtain(d, "structure_declare"), e.initSvg(), a.push(e), b.push(2 * c));
    b.length && (b[b.length - 1] = 3 * c);
    e = Blockly.Structure.allStructure();
    (function(f, g) {
        for (var h = 0; h < f.length; h++) {
            var k = Blockly.Block.obtain(d, g);
            k.setFieldValue(f[h][2], "NAME");
            k.initSvg();
            a.push(k);
            b.push(2 * c)
        }
...
Blockly.Structure.getCallers = function(a, b) {
...
Blockly.Structure.disposeCallers = function(a, b) {
    for (var c = Blockly.Structure.getCallers(a, b), d = 0; d < c.length; d++) c[d].dispose(!0, !1)
};
Blockly.Structure.mutateCallers = function(a, b, c, d, e, f, g) {
    a = Blockly.Structure.getCallers(a, c);
    for (b = 0; b < a.length; b++) a[b].setProcedureParameters(d, e, f, g)
};
Blockly.Structure.getDefinition = function(a, b) {
...
Blockly.Structure.returnTypeCheck = function(a, b) {};
Blockly.FieldStructure = function(a, b) {
    Blockly.FieldStructure.superClass_.constructor.call(this, Blockly.FieldStructure.dropdownCreate, b);
    a ? this.setValue(a) : this.setValue(Blockly.Variables.generateUniqueName())
};
...
Blockly.FieldStructure.prototype.setValue = function(a) {
    this.value_ = a;
    this.setText(a)
};
Blockly.FieldStructure.dropdownCreate = function() {
    for (var a = Blockly.Structure.allStructure(), b = [], c = 0; c < a[0].length; c++) "sd" == a[0][c][0] && b.push(a[0][c][1]);
    (a = this.getText()) && -1 == b.indexOf(a) ? b.push(a) : b.push("-Type-");
    b.sort(goog.string.caseInsensitiveCompare);
    a = [];
    for (c = 0; c < b.length; c++) a[c] = [b[c], b[c]];
    return a
};
Blockly.FieldStructureMember = function(a, b, c) {
    Blockly.FieldStructureMember.superClass_.constructor.call(this, Blockly.FieldStructureMember.dropdownCreate, b, c);
    a ? this.setValue(a) : this.setValue(Blockly.Variables.generateUniqueName())
};
...
Blockly.FieldStructureMember.prototype.setValue = function(a) {
    this.value_ = a;
    this.setText(a)
};
Blockly.FieldStructureMember.dropdownCreate = function(a) {
    var b = Blockly.Structure.allStructure(),
        c = [];
    a = a.getInput("struct").fieldRow[0].text_;
    for (var d = 0; d < b[1].length; d++)
        if (b[1][d][2] == a)
            for (var e = 0; e < b[1][d][4].length; e++) c.push(b[1][d][4][e]);
    (b = this.getText()) && -1 == c.indexOf(b) ? c.push(b) : c.push("--Select--");
    c.push("Itself");
    c.sort(goog.string.caseInsensitiveCompare);
    b = [];
    for (a = 0; a < c.length; a++) b[a] = [c[a], c[a]];
    return b
};
Blockly.FieldStructureMember.dropdownChange = function(a) {
    a.getInput("struct").removeField("Mem");
    a.getInput("struct").appendField(new Blockly.FieldStructureMember("--Select--", null, a), "Mem")
};
...
Blockly.FieldVariablePointer = function(a, b, c) {
    Blockly.FieldVariablePointer.superClass_.constructor.call(this, Blockly.FieldVariablePointer.dropdownCreate, b, c);
    a ? this.setValue(a) : this.setValue(Blockly.Variables.generateUniqueName())
};
...
Blockly.FieldVariablePointer.prototype.setValue = function(a) {
    this.value_ = a;
    this.setText(a)
};
Blockly.FieldVariablePointer.dropdownCreate = function(a) {
    a = Blockly.FieldDropdown.prototype.listCreate(a, 2);
    var b = this.getText();
    b && -1 == a.indexOf(b) ? a.push(b) : a.push(Blockly.Msg.SELECT_MENU);
    a.sort(goog.string.caseInsensitiveCompare);
    b = [];
...
Blockly.FieldVariableArray = function(a, b, c) {
    Blockly.FieldVariableArray.superClass_.constructor.call(this, Blockly.FieldVariableArray.dropdownCreate, b, c);
    a ? this.setValue(a) : this.setValue(Blockly.Variables.generateUniqueName())
};
...
Blockly.FieldVariableArray.prototype.setValue = function(a) {
    this.value_ = a;
    this.setText(a)
};
Blockly.FieldVariableArray.dropdownCreate = function(a) {
    a = Blockly.FieldDropdown.prototype.listCreate(a, 3);
    var b = this.getText();
    b && -1 == a.indexOf(b) ? a.push(b) : a.push(Blockly.Msg.SELECT_MENU);
    a.sort(goog.string.caseInsensitiveCompare);
    b = [];
...
Blockly.FieldVariableArray.getBlockIdxLength = function(a) {
    for (var b = Blockly.Variables.allVariables(), c = 0; c < b.length; c++)
        if (b[c][2] == a) return b[c][5][0]
};
Blockly.FieldVariableDefine = function(a, b, c) {
    Blockly.FieldVariableDefine.superClass_.constructor.call(this, Blockly.FieldVariableDefine.dropdownCreate, b, c);
    a ? this.setValue(a) : this.setValue(Blockly.Variables.generateUniqueName())
};
...
Blockly.FieldVariableDefine.prototype.setValue = function(a) {
    this.value_ = a;
    this.setText(a)
};
Blockly.FieldVariableDefine.dropdownCreate = function(a) {
    a = Blockly.FieldDropdown.prototype.listCreate(a, 0);
    var b = this.getText();
    b && -1 == a.indexOf(b) ? a.push(b) : a.push(Blockly.Msg.SELECT_MENU);
    a.sort(goog.string.caseInsensitiveCompare);
    b = [];
...
Blockly.Procedures.allProcedures = function() {
    for (var a = Blockly.mainWorkspace.getAllBlocks(), b = [], c = [], d = 0; d < a.length; d++) {
        ...
        e && (e = e.call(a[d])) && (e[0] ? b.push(e) : c.push(e))
    }
...
Blockly.Procedures.isLegalName = function(a, b, c) {
    ...
    for (var d = 0; d < b.length; d++)
        if (b[d] != c) {
            var e;
            if (e = "procedures_defreturn" == b[d].type || "procedures_defnoreturn" == b[d].type ? b[d].getProcedureDef : "structure_define" == b[d].type ? b[d].getName : b[d].getDeclare) {
                var f = e.call(b[d]);
                if (e == b[d].getProcedureDef) {
                    if (Blockly.Names.equals(f[1], a)) return !1
                } else if (Blockly.Names.equals(f[0], a)) return !1
            }
        } return !0
};
Blockly.Procedures.rename = function(a) {
    ...
    return a = Blockly.Names.prototype.safeName_(a)
};
Blockly.Procedures.flyoutCategory = function(a, b, c, d) {
    function e(g, h) {
        for (var k = 0; k < g.length; k++) {
            var l = Blockly.Block.obtain(d, h);
            l.setFieldValue(g[k][1], "NAME");
            for (var m = [], n = 0; n < g[k][3].length; n++) m[n] = "ARG" + n;
            l.setProcedureParameters(g[k][3], g[k][4], g[k][5], g[k][6], m);
            l.initSvg();
            a.push(l);
            b.push(2 * c)
        }
    ...
    Blockly.Blocks.procedures_defreturn && (f = Blockly.Block.obtain(d, "procedures_defreturn"),
        f.initSvg(), a.push(f), b.push(2 * c));
    Blockly.Blocks.procedures_return && (f = Blockly.Block.obtain(d, "procedures_return"), f.initSvg(), a.push(f), b.push(2 * c));
    b.length && (b[b.length - 1] = 3 * c);
...
Blockly.Procedures.mutateCallers = function(a, b, c, d, e, f, g, h) {
    a = Blockly.Procedures.getCallers(a, c);
    for (b = 0; b < a.length; b++) a[b].setProcedureParameters(d, e, f, g, h)
};
Blockly.Procedures.getDefinition = function(a, b) {
    for (var c = b.getAllBlocks(), d = 0; d < c.length; d++) {
        var e = c[d].getProcedureDef;
        if (e && (e = e.call(c[d])) && Blockly.Names.equals(e[1], a)) return c[d]
    }
    return null
};
Blockly.Procedures.typeCheck = function() {};
Blockly.Procedures.returnTypeCheck = function(a, b) {};
Blockly.Procedures.getTypePlusArgs = function(a) {
    for (var b = [], c = [], d = [], e = [], f = [], g = 0; g < a.arguments_.length; g++) b[g] = Blockly.cake.variableDB_.getName(a.arguments_[g], Blockly.Variables.NAME_TYPE), c[g] = a.types_[g], d[g] = a.dist_[g], e[g] = a.spec_[g], "v" == d[g] ? f[g] = c[g] + " " + b[g] : "a" == d[g] ? 1 == e[g][0] ? f[g] = c[g] + " " + b[g] + "[" + e[g][1] + "]" : 2 == e[g][0] ? f[g] = c[g] + " " + b[g] + "[" + e[g][1] + "][" + e[g][2] + "]" : 3 == e[g][0] && (f[g] = c[g] + " " + b[g] + "[" + e[g][1] + "][" + e[g][2] + "][" + e[g][2] + "]") : "p" == d[g] && (f[g] = c[g] + e[g] + " " + b[g]);
    return f
};
var rtclient = {
...
rtclient.Authorizer.prototype.authorize = function(a) {
    var b = this.clientId,
        ...
        d = this,
        e = function(g) {
            g && !g.error ? (d.authButton.disabled = !0, d.fetchUserId(a), d.authDiv.style.display = "none") : (d.authButton.disabled = !1, d.authButton.onclick = f, d.authDiv.style.display = "block")
        },
        f = function() {
            gapi.auth.authorize({
                client_id: b,
    ...
    function f() {
        ...
        gapi.client.drive.properties.get({
            ...
            if (k.error) c ?
                ...
                var l = k.result.value;
                gapi.client.drive.files.get({
                    fileId: l
                }).execute(function(m) {
                    m.error || m.labels.trashed ? h() : e(l)
                })
            }
        })
    }
...
Blockly.Realtime.placeBlockOnWorkspace_ = function(a, b) {
    Blockly.Realtime.doWithinSync_(function() {
        ...
        if (c = Blockly.Xml.domToBlock(Blockly.mainWorkspace, c, !0)) b && c.workspace.addTopBlock(c), (b || module$contents$goog$array_contains(Blockly.Realtime.topBlocks_, c)) && Blockly.Realtime.moveBlock_(c)
    })
};
...
Blockly.Realtime.afterCreate_ = function(a) {
    ...
    b.execute(function(c) {
        c.error && Blockly.Realtime.getUserDomain(a, function(d) {
...
Blockly.Realtime.startRealtime = function(a, b, c) {
    ...
    Blockly.Realtime.initUi_ = function() {
        ...
        if (Blockly.Realtime.chatBoxElementId_) {
            var d = Blockly.Realtime.model_.getRoot().get(Blockly.Realtime.chatBoxElementId_),
                e = document.getElementById(Blockly.Realtime.chatBoxElementId_);
            gapi.drive.realtime.databinding.bindString(d, e);
            e.disabled = !1
        }
    };
...
Blockly.Css.CONTENT = [".blocklySvg {", "  background-color: #fff;", "  border: 1px solid #ddd;", "  overflow: hidden;", "}", ".blocklyWidgetDiv {", "  position: absolute;", "  display: none;", "  z-index: 999;", "}", ".blocklyDraggable {", "  cursor: url(<<<PATH>>>/media/handopen.cur) 8 5, auto;", "}", ".blocklyResizeSE {", "  fill: #aaa;", "  cursor: se-resize;", "}", ".blocklyResizeSW {", "  fill: #aaa;", "  cursor: sw-resize;", "}", ".blocklyResizeLine {", "  stroke-width: 1;", "  stroke: #888;", "}", ".blocklyHighlightedConnectionPath {",
    ...
    "  fill-opacity: .5;", "  stroke-opacity: .5;", "}", ".blocklyDisabled>.blocklyPathLight,", ".blocklyDisabled>.blocklyPathDark {", "  display: none;", "}", ".blocklyText {", "  cursor: default;", '  font-family: "Source Code Pro","Nanum Gothic Coding",Menlo,Monaco,Consolas,"Courier New",monospace;', "  font-size: 10pt;", "  fill: #fff;", "}", ".blocklyNonEditableText>text {", "  pointer-events: none;", "}", ".blocklyNonEditableText>rect,", ".blocklyEditableText>rect {", "  fill: #fff;", "  fill-opacity: .6;", "}", ".blocklyNonEditableText>text,",
    ...
    "}", ".blocklyTooltipShadow,", ".blocklyDropdownMenuShadow {", "  fill: #bbb;", "  filter: url(#blocklyShadowFilter);", "}", ".blocklyTooltipText {", '  font-family: "Source Code Pro","Nanum Gothic Coding",Menlo,Monaco,Consolas,"Courier New",monospace;', "  font-size: 9pt;", "  fill: #000;", "}", ".blocklyIconShield {", "  cursor: default;", "  fill: #00c;", "  stroke-width: 1px;", "  stroke: #ccc;", "}", ".blocklyIconGroup:hover>.blocklyIconShield {", "  fill: #00f;", "  stroke: #fff;", "}", ".blocklyIconGroup:hover>.blocklyIconMark {",
    "  fill: #fff;", "}", ".blocklyIconMark {", "  cursor: default !important;", '  font-family: "Source Code Pro","Nanum Gothic Coding",Menlo,Monaco,Consolas,"Courier New",monospace;', "  font-size: 9pt;", "  font-weight: bold;", "  fill: #ccc;", "  text-anchor: middle;", "}", ".blocklyWarningBody {", "}", ".blocklyMinimalBody {", "  margin: 0;", "  padding: 0;", "}", ".blocklyCommentTextarea {", "  margin: 0;", "  padding: 2px;", "  border: 0;", "  resize: none;", "  background-color: #ffc;", "}", ".blocklyHtmlInput {", '  font-family: "Source Code Pro","Nanum Gothic Coding",Menlo,Monaco,Consolas,"Courier New",monospace;',
    "  font-size: 10pt;", "  border: none;", "  outline: none;", "  width: 100%", "}", ".blocklyMutatorBackground {", "  fill: #fff;", "  stroke-width: 1;", "  stroke: #ddd;", "}", ".blocklyFlyoutBackground {", "  fill: #ddd;", "  fill-opacity: .8;", "}", ".blocklyColourBackground {", "  fill: #666;", "}", ".blocklyScrollbarBackground {", "  fill: #fff;", "  stroke-width: 1;", "  stroke: #e4e4e4;", "}", ".blocklyScrollbarKnob {", "  fill: #ccc;", "}", ".blocklyScrollbarBackground:hover+.blocklyScrollbarKnob,", ".blocklyScrollbarKnob:hover {",
    ...
    "}", ".blocklyWidgetDiv .goog-option-selected .goog-menuitem-checkbox,", ".blocklyWidgetDiv .goog-option-selected .goog-menuitem-icon {", "  background: url(<<<PATH>>>/media/sprites.png) no-repeat 0 0 !important;", "}", ".blocklyToolboxDiv {", "  background-color: #f5f5f5;", "  display: none;", "  overflow-x: visible;", "  overflow-y: auto;", "  position: absolute;", "}", ".blocklyTreeRoot {", "  padding: 4px 0;", "}", ".blocklyTreeRoot:focus {", "  outline: none;", "}", ".blocklyTreeRow {", "  line-height: 22px;",
    "  height: 22px;", "  padding-right: 1em;", "  white-space: nowrap;", "}", '.blocklyToolboxDiv[dir="RTL"] .blocklyTreeRow {', "  padding-right: 0;", "  padding-left: 1em !important;", "}", ".blocklyTreeRow:hover {", "  background-color: #e4e4e4;", "}", ".blocklyTreeIcon {", "  height: 16px;", "  width: 16px;", "  vertical-align: middle;", "  background-image: url(<<<PATH>>>/media/tree.png);", "}", ".blocklyTreeIconClosedLtr {", "  background-position: -32px -1px;", "}", ".blocklyTreeIconClosedRtl {", "  background-position: 0px -1px;",
    ...
    "  cursor: default;", '  font-family: "Source Code Pro","Nanum Gothic Coding",Menlo,Monaco,Consolas,"Courier New",monospace;', "  font-size: 14px;", "  padding: 0 3px;", "  vertical-align: middle;", "}", ".blocklyTreeSelected  {", "  background-color: #57e !important;", "}", ".blocklyTreeSelected .blocklyTreeLabel {", "  color: #fff;", "}", ".blocklyWidgetDiv .goog-palette {", "  outline: none;", "  cursor: default;", "}", ".blocklyWidgetDiv .goog-palette-table {", "  border: 1px solid #666;", "  border-collapse: collapse;",
...
Blockly.parseOptions_ = function(a) {
    ...
    if (b) var c = !1,
        ...
        e = !1,
        f = null;
    else f = Blockly.parseToolboxTree_(a.toolbox), c = !(!f || !f.getElementsByTagName("category").length), d = a.trashcan, void 0 === d && (d = c), e = a.collapse, void 0 === e && (e = c);
    if (f && !c) var g = !1;
...
Blockly.createDom_ = function(a) {
    ...
    var d = Blockly.createSvgElement("filter", {
        id: "blocklyEmboss"
    }, c);
    ...
    var e = Blockly.createSvgElement("feSpecularLighting", {
        "in": "blur",
        surfaceScale: 1,
        specularConstant: .5,
        specularExponent: 10,
    ...
    Blockly.readOnly ||
        (Blockly.hasCategories ? Blockly.Toolbox.createDom(b, a) : (Blockly.mainWorkspace.flyout_ = new Blockly.Flyout, c = Blockly.mainWorkspace.flyout_, d = c.createDom(), c.init(Blockly.mainWorkspace, !0), c.autoClose = !1, goog.dom.insertSiblingBefore(d, Blockly.mainWorkspace.svgGroup_), Blockly.addChangeListener(function() {
            if (0 == Blockly.Block.dragMode_) {
                var f = Blockly.mainWorkspace.getMetrics();
                if (0 > f.contentTop || f.contentTop + f.contentHeight > f.viewHeight + f.viewTop || f.contentLeft < (Blockly.RTL ? f.viewLeft : 0) || f.contentLeft +
                    f.contentWidth > (Blockly.RTL ? f.viewWidth : f.viewWidth + f.viewLeft))
                    for (var g = Blockly.mainWorkspace.getTopBlocks(!1), h = 0, k; k = g[h]; h++) {
                        var l = k.getRelativeToSurfaceXY(),
                            m = k.getHeightWidth(),
                            n = f.viewTop + 25 - m.height - l.y;
                        0 < n && k.moveBy(0, n);
                        n = f.viewTop + f.viewHeight - 25 - l.y;
                        0 > n && k.moveBy(0, n);
                        n = 25 + f.viewLeft - l.x - (Blockly.RTL ? 0 : m.width);
                        0 < n && k.moveBy(n, 0);
                        n = f.viewLeft + f.viewWidth - 25 - l.x + (Blockly.RTL ? m.width : 0);
                        0 > n && k.moveBy(n, 0);
                        k.isDeletable() && 50 < (Blockly.RTL ? l.x - f.viewWidth : -l.x) && k.dispose(!1, !0)
                    }
            }
        })));
...
Blockly.init_ = function() {
    var a = [],
        b = function() {
            for (; a.length;) Blockly.unbindEvent_(a.pop());
            Blockly.preloadAudio_()
        };
    a.push(Blockly.bindEvent_(document, "mousemove", null, b));
    a.push(Blockly.bindEvent_(document, "touchstart", null, b));
...
Blockly.bindEvent_ = function(a, b, c, d) {
    ...
    b in Blockly.bindEvent_.TOUCH_MAP && (e = function(g) {
        if (1 == g.changedTouches.length) {
...
Blockly.showContextMenu_ = function(a) {
    if (!Blockly.readOnly) {
        ...
        if (Blockly.collapse) {
            ...
            d.callback = function() {
                for (var h = 0, k = 0; k < e.length; k++)
                    for (var l = e[k]; l;) setTimeout(l.setCollapsed.bind(l, !0), h), l = l.getNextBlock(), h += 10
            };
            b.push(d);
            c = {
                enabled: c
            ...
            c.callback = function() {
                for (var h = 0,
                        k = 0; k < e.length; k++)
                    for (var l = e[k]; l;) setTimeout(l.setCollapsed.bind(l, !1), h), l = l.getNextBlock(), h += 10
            };
            b.push(c)
        }
...
Blockly.getMainWorkspaceMetrics_ = function() {
    ...
    if (Blockly.mainWorkspace.scrollbar) {
        var e = Math.min(d.x - b / 2, d.x + d.width - b);
        b = Math.max(d.x + d.width + b / 2, d.x + b);
        var f = Math.min(d.y - c / 2, d.y + d.height - c);
